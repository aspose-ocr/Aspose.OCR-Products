---
title: 通過 Java 將 GIF 轉換為 TXT 
url: /zh-hant/java/conversion/gif-to-txt/ 
description: GIF 格式到 TXT 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 GIF 轉換為 TXT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 GIF 轉換為 TXT" h2="使用光學字符識別從 GIF 讀取文本。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 GIF 轉換為 TXT" %}}

為了將 GIF 渲染為 TXT，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 GIF 轉換為 TXT 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF轉TXT Java轉換源碼" offSpacer="" %}}
```cs
