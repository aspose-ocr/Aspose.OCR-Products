---
title: 通過 Java 將 JPEG 轉換為 TXT 
url: /zh-hant/java/conversion/jpeg-to-txt/ 
description: JPEG 格式到 TXT 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 JPEG 轉換為 TXT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 JPEG 轉換為 TXT" h2="使用光學字符識別從 JPEG 讀取文本。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 JPEG 轉換為 TXT" %}}

為了將 JPEG 渲染為 TXT，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 JPEG 轉換為 TXT 的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="JPEG轉TXT Java轉換源碼" offSpacer="" %}}
```cs
