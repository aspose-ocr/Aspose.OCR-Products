---
title: تحويل BMP إلى TXT عبر Java 
url: /ar/java/conversion/bmp-to-txt/ 
description: نموذج كود تحويل Java لتنسيق BMP إلى ملف TXT. استخدم رمز المثال هذا لتحويل BMP إلى TXT داخل أي تطبيق يستند إلى Web أو Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل BMP إلى TXT عبر Java" h2="قراءة النص من BMP باستخدام التعرف الضوئي على الحروف." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل BMP إلى TXT باستخدام Java" %}}

من أجل تقديم BMP إلى TXT ، سنستخدمه
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل BMP إلى TXT عبر Java" %}}
...
{{% blocks/products/pf/agp/code-block title="BMP إلى TXT شفرة مصدر تحويل جافا" offSpacer="" %}}
