---
title: Convert PNG to TXT via .NET 
weight: 70
...
{{< blocks/products/pf/upper-banner h1="Convert PNG to TXT via C#" h2="Convert PNG to text in any .NET based application using Optical Character Recognition." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.OCR makes it easy for the developers to load & convert PNG files to TXT in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PNG to TXT" sectionDescription="Check our live demos for [PNG to TXT conversion](https://products.aspose.app/ocr/conversion/png-to-txt) with following benefits." >}}
