...
{{% blocks/products/pf/agp/content h2="Как преобразовать DJVU в Text с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию DJVU в Text" %}}
...
{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает преобразование DJVU в Text .NET" offSpacer="true" %}}
