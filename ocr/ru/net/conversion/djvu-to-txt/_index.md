...
{{% blocks/products/pf/agp/content h2="Как преобразовать DJVU в TXT с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию DJVU в TXT" %}}
...
{{% blocks/products/pf/agp/code-block title="Этот пример кода показывает преобразование DJVU в TXT .NET" offSpacer="true" %}}
