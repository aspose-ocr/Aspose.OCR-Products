...
title:  
weight: 3920
url: /ru/java/conversion/tiff-to-docx/ 
lang: ru
langdirlevel: 2
...
С помощью Java OCR и всего нескольких строк кода вы можете создать полнофункциональное приложение, которое преобразует изображение TIFF в документ DOCX:
