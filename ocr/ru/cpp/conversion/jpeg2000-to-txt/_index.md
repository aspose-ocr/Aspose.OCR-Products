...
title:  
weight: 3920
url: /ru/cpp/conversion/jpeg2000-to-txt/ 
lang: ru
langdirlevel: 2
...
С помощью C++ OCR и всего нескольких строк кода вы можете создать полнофункциональное приложение, которое преобразует изображение JPEG2000 в документ TXT:
