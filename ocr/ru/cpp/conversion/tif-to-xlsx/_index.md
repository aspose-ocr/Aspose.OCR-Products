...
title:  
weight: 3920
url: /ru/cpp/conversion/tif-to-xlsx/ 
lang: ru
langdirlevel: 2
...
С помощью C++ OCR и всего нескольких строк кода вы можете создать полнофункциональное приложение, которое преобразует изображение TIF в документ XLSX:
...
+ AsposeOCR.asposeocr_page возвращает строку или файл типа XLSX
