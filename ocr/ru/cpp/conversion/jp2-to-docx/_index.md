...
title:  
weight: 3920
url: /ru/cpp/conversion/jp2-to-docx/ 
lang: ru
langdirlevel: 2
...
С помощью C++ OCR и всего нескольких строк кода вы можете создать полнофункциональное приложение, которое преобразует изображение JP2 в документ DOCX:
