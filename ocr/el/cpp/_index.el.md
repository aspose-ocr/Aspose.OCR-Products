...
{{< blocks/products/pf/upper-banner h1="Μετατρέψτε εικόνες και PDF σε κείμενο σε C++" h2="Προσθέστε οπτική αναγνώριση χαρακτήρων (OCR) στις εφαρμογές σας C++ με μερικές γραμμές κώδικα." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/headers/aspose_ocr-for-cpp.svg" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="https://releases.aspose.com/ocr/cpp" >}}
...
{{< blocks/products/pf/slr-element name="Σημειώσεις έκδοσης" href="https://releases.aspose.com/ocr/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
