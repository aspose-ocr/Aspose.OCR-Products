...
<div id="code" class="codeblock"><h3>Live code sample - C++</h3><pre><code class="cs hljs csharp"><span class="hljs-comment">// Prepare buffer for result</span>
<span class="hljs-keyword">const</span> <span class="hljs-built_in">size_t</span> len = 4096;
<span class="hljs-keyword">const</span> buffer[len] = { 0 };
<span class="hljs-comment">// Do the magic</span>
<span class="hljs-built_in">size_t</span> size = aspose::ocr::page(L"<span class="hljs-string"><span class="ocr-lcs-code-filename-placeholder">&lt;file name&gt;</span><span class="ocr-lcs-code-filename-actual"></span></span>", buffer, len);
<span class="hljs-comment">// Display the recognition result</span>
std::wcout <span class="hljs-keyword"><<</span> buffer <span class="hljs-keyword"><<</span> L"<span class="hljs-string">\n</span>";</code></pre></div>
...
{{< blocks/products/pf/slr-element name="Release Notes" href="https://releases.aspose.com/ocr/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
