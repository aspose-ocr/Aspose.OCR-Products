---
title: Convert BMP to XLS via C++ 
weight: 3920
url: /cpp/conversion/bmp-to-xls/ 
lang: en
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Convert BMP to XLS in C++" h2="Perform optical character recognition on BMP document and save text as BMP document using Aspose.OCR fro C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
With C++ OCR and just a few lines of code, you can create full-featured application that converts an BMP image to XLS document:
...
{{% blocks/products/pf/agp/code-block title="This sample code shows BMP to XLS C++ Conversion" offSpacer="true" %}}
