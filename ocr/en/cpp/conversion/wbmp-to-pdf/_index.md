---
title: Convert WBMP to PDF via C++ 
weight: 3920
url: /cpp/conversion/wbmp-to-pdf/ 
lang: en
langdirlevel: 2
...
{{< blocks/products/pf/upper-banner h1="Convert WBMP to PDF in C++" h2="Perform optical character recognition on WBMP document and save text as WBMP document using Aspose.OCR fro C++ library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
With C++ OCR and just a few lines of code, you can create full-featured application that converts an WBMP image to PDF document:
...
{{% blocks/products/pf/agp/code-block title="This sample code shows WBMP to PDF C++ Conversion" offSpacer="true" %}}
