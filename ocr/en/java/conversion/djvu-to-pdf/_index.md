...
With Java OCR and just a few lines of code, you can create full-featured application that converts an DJVU image to PDF document:
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DJVU to PDF Java Conversion" offSpacer="true" %}}
