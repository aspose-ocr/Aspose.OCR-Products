...
title:  
weight: 3920
url: /java/conversion/jpg-to-doc/ 
lang: en
langdirlevel: 2
...
With Java OCR and just a few lines of code, you can create full-featured application that converts an JPG image to DOC document:
