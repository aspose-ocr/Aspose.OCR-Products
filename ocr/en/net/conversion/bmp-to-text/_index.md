...
{{< blocks/products/pf/upper-banner h1="Convert BMP to Text in C#" h2="Perform optical character recognition on BMP document and save text as BMP document using Aspose.OCR for .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Text" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
Aspose.OCR for .NET is a powerful yet easy-to-use and cost-effective library for converting BMP images to Text documents. Supporting 26 languages based on Latin, Cyrillic and Chinese, its state-of-the-art optical character recognition engine provides superior recognition speed and accuracy, while isolating you from formulas, neural networks, and other complex technical details. It allows you to add OCR functionality to your .NET applications in less than 10 lines of code.
...
With .NET OCR and just a few lines of code, you can create full-featured application that converts an BMP image to Text document:
...
{{% blocks/products/pf/agp/code-block title="This live code sample shows BMP to Text .NET Conversion" offSpacer="true" %}}
...
<div class="ocr-lcs">
	...
	<div class="ocr-lcs-controls">
		<div class="ocr-lcs-drop" onclick="OcrLcsUpload(this);" ondragover="event.preventDefault();" ondrop="OcrLcsDropped(event,this);">
			<input type="file" accept=".bmp" onchange="OcrLcsFileSelected(this);" />
