---
title: Convert WBMP to XML via C# 
weight: 3920
url: /net/conversion/wbmp-to-xml/ 
lang: en
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Sample code for WBMP to XML C# conversion. Use API example code for batch WBMP files to XML conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert WBMP to XML in C#" h2="Perform optical character recognition on WBMP document and save text as WBMP document using Aspose.OCR for .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="How to convert WBMP to XML using C#" %}}

Aspose.OCR for .NET is a powerful yet easy-to-use and cost-effective library for converting WBMP images to XML documents. Supporting 26 languages based on Latin, Cyrillic and Chinese, its state-of-the-art optical character recognition engine provides superior recognition speed and accuracy, while isolating you from formulas, neural networks, and other complex technical details. It allows you to add OCR functionality to your .NET applications in less than 10 lines of code.
...
With .NET OCR and just a few lines of code, you can create full-featured application that converts an WBMP image to XML document:
...
{{% blocks/products/pf/agp/code-block title="This sample code shows WBMP to XML .NET Conversion" offSpacer="true" %}}
