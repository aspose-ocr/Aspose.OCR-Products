...
{{< blocks/products/pf/upper-banner h1="Convert DJVU to PDF in C#" h2="Perform optical character recognition on DJVU document and save text as DJVU document using Aspose.OCR fro .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DJVU to PDF C# Conversion" offSpacer="true" %}}
