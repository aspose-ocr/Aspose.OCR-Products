---
title: Convert DJVU to DOCX via C# 
weight: 3920
url: /net/conversion/djvu-to-docx/ 
lang: en
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Sample code for DJVU to DOCX C# conversion. Use API example code for batch DJVU files to DOCX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DJVU to DOCX in C#" h2="Perform optical character recognition on DJVU document and save text as DJVU document using Aspose.OCR for .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="How to convert DJVU to DOCX using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DJVU to DOCX" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DJVU to DOCX .NET Conversion" offSpacer="true" %}}
