...
{{< blocks/products/pf/upper-banner h1="Convert JPEG to DOCX in C#" h2="Perform optical character recognition on JPEG document and save text as JPEG document using Aspose.OCR for .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows JPEG to DOCX .NET Conversion" offSpacer="true" %}}
