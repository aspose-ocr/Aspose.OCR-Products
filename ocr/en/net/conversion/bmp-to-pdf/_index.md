...
{{< blocks/products/pf/upper-banner h1="Convert BMP to PDF in C#" h2="Perform optical character recognition on BMP document and save text as BMP document using Aspose.OCR for .NET library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows BMP to PDF .NET Conversion" offSpacer="true" %}}
