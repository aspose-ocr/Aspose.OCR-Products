...
title:  
weight: 3920
url: /ko/java/conversion/tif-to-xlsx/ 
lang: ko
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIF에서 XLSX로의 Java 변환을 위한 샘플 코드입니다. 웹 또는 데스크톱 자바 기반 애플리케이션 내에서 일괄 TIF 파일을 XLSX로 변환하는 API 예제 코드를 사용합니다.
---
...
Java OCR과 몇 줄의 코드만으로 TIF 이미지를 XLSX 문서로 변환하는 완전한 기능의 애플리케이션을 만들 수 있습니다.
