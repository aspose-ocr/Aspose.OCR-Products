---
title: Java를 통해 GIF를 TXT로 변환 
url: /ko/java/conversion/gif-to-txt/ 
description: GIF 형식을 TXT 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크탑 Java 기반 애플리케이션 내에서 GIF를 TXT로 변환합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java를 통해 GIF를 TXT로 변환" h2="광학 문자 인식을 사용하여 GIF에서 텍스트를 읽습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 GIF를 TXT로 변환하는 방법" %}}

GIF를 TXT로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 GIF를 TXT로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF에서 TXT로 Java 변환 소스 코드" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GIF를 TXT로 변환하는 무료 앱" sectionDescription="" >}}
