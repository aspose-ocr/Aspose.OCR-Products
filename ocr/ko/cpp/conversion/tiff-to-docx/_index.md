...
title:  
weight: 3920
url: /ko/cpp/conversion/tiff-to-docx/ 
lang: ko
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIFF에서 DOCX로의 Java 변환을 위한 샘플 코드입니다. 웹 또는 데스크톱 자바 기반 애플리케이션 내에서 일괄 TIFF 파일을 DOCX로 변환하는 API 예제 코드를 사용합니다.
---
...
C++ OCR과 몇 줄의 코드만 있으면 TIFF 이미지를 DOCX 문서로 변환하는 완전한 기능의 애플리케이션을 만들 수 있습니다.
