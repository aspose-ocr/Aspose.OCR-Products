...
title:  
weight: 3920
url: /pt/cpp/conversion/jpeg2000-to-searchable_pdf/ 
lang: pt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de exemplo para conversão Java de JPEG2000 para Searchable PDF. Use o código de exemplo da API para arquivos em lote JPEG2000 para conversão Searchable PDF em qualquer aplicativo baseado em Java da Web ou Desktop.
---
...
Com OCR C++ e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem JPEG2000 em um documento Searchable PDF:
