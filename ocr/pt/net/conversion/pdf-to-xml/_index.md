...
{{% blocks/products/pf/agp/content h2="Como converter PDF para XML usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PDF em XML" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PDF para XML .NET" offSpacer="true" %}}
