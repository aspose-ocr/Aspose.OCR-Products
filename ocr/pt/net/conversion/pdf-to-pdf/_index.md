...
{{% blocks/products/pf/agp/content h2="Como converter PDF para PDF usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PDF em PDF" %}}

{{% blocks/products/pf/agp/text %}}

Com o OCR .NET e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem PDF em um documento PDF:
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PDF para PDF .NET" offSpacer="true" %}}
