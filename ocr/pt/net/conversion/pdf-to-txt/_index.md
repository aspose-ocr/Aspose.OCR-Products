...
{{% blocks/products/pf/agp/content h2="Como converter PDF para TXT usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PDF em TXT" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PDF para TXT .NET" offSpacer="true" %}}
