...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JPG em PDF" %}}

{{% blocks/products/pf/agp/text %}}

Com o OCR .NET e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem JPG em um documento PDF:
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de JPG para PDF .NET" offSpacer="true" %}}
