...
description: Código de exemplo para conversão Java de GIF para TXT. Use o código de exemplo da API para arquivos em lote GIF para conversão TXT em qualquer aplicativo baseado em Java da Web ou Desktop.
---
...
Com Java OCR e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem GIF em um documento TXT:
