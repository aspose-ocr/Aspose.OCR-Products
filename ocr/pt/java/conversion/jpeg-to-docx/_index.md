...
title:  
weight: 3920
url: /pt/java/conversion/jpeg-to-docx/ 
lang: pt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de exemplo para conversão Java de JPEG para DOCX. Use o código de exemplo da API para arquivos em lote JPEG para conversão DOCX em qualquer aplicativo baseado em Java da Web ou Desktop.
---
...
Com Java OCR e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem JPEG em um documento DOCX:
