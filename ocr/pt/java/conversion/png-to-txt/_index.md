...
title:  
weight: 3920
url: /pt/java/conversion/png-to-txt/ 
lang: pt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de exemplo para conversão Java de PNG para TXT. Use o código de exemplo da API para arquivos em lote PNG para conversão TXT em qualquer aplicativo baseado em Java da Web ou Desktop.
---
...
Com Java OCR e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem PNG em um documento TXT:
