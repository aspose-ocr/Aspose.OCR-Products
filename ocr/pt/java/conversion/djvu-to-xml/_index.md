...
title:  
weight: 3920
url: /pt/java/conversion/djvu-to-xml/ 
lang: pt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de exemplo para conversão Java de DJVU para XML. Use o código de exemplo da API para arquivos em lote DJVU para conversão XML em qualquer aplicativo baseado em Java da Web ou Desktop.
---
