...
title:  
weight: 3920
url: /pt/java/conversion/bmp-to-text/ 
lang: pt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de exemplo para conversão Java de BMP para Text. Use o código de exemplo da API para arquivos em lote BMP para conversão Text em qualquer aplicativo baseado em Java da Web ou Desktop.
---
