...
title:  
weight: 3920
url: /pt/java/conversion/tif-to-searchable_pdf/ 
lang: pt
langdirlevel: 2
...
Com Java OCR e apenas algumas linhas de código, você pode criar um aplicativo completo que converte uma imagem TIF em um documento Searchable PDF:
