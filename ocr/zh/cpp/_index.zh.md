...
{{< blocks/products/pf/upper-banner h1="在 C++ 中将图像和 PDF 转换为文本" h2="只需几行代码，即可将光学字符识别 (OCR) 添加到您的 C++ 应用程序中。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/headers/aspose_ocr-for-cpp.svg" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/ocr/cpp" >}}
...
{{< blocks/products/pf/slr-element name="发行说明" href="https://docs.aspose.com/ocr/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
