---
title: 通过 Java 将 TIFF 转换为 TXT 
url: /zh/java/conversion/tiff-to-txt/ 
description: TIFF 格式到 TXT 文件的示例 Java 转换代码。使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 TIFF 转换为 TXT。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 TIFF 转换为 TXT" h2="使用光学字符识别从 TIFF 读取文本。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 TIFF 转换为 TXT" %}}

为了将 TIFF 渲染为 TXT，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 TIFF 转换为 TXT 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="TIFF转TXT Java转换源码" offSpacer="" %}}
```cs
