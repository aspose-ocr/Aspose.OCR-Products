...
description: Mã mẫu cho chuyển đổi Java từ JPG sang PDF. Sử dụng mã mẫu API cho hàng loạt tệp JPG thành chuyển đổi PDF trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
...
Với Java OCR và chỉ một vài dòng mã, bạn có thể tạo ứng dụng đầy đủ tính năng để chuyển đổi hình ảnh JPG thành tài liệu PDF:
