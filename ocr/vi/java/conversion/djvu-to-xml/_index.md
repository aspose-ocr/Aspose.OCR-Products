...
title:  
weight: 3920
url: /vi/java/conversion/djvu-to-xml/ 
lang: vi
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Mã mẫu cho chuyển đổi Java từ DJVU sang XML. Sử dụng mã mẫu API cho hàng loạt tệp DJVU thành chuyển đổi XML trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
...
Với Java OCR và chỉ một vài dòng mã, bạn có thể tạo ứng dụng đầy đủ tính năng để chuyển đổi hình ảnh DJVU thành tài liệu XML:
