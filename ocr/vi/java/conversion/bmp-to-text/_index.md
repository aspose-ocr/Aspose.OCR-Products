...
title:  
weight: 3920
url: /vi/java/conversion/bmp-to-text/ 
lang: vi
langdirlevel: 2
...
Với Java OCR và chỉ một vài dòng mã, bạn có thể tạo ứng dụng đầy đủ tính năng để chuyển đổi hình ảnh BMP thành tài liệu Text:
