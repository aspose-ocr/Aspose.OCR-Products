...
title:  
weight: 3920
url: /vi/cpp/conversion/djvu-to-txt/ 
lang: vi
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Mã mẫu cho chuyển đổi Java từ DJVU sang TXT. Sử dụng mã mẫu API cho hàng loạt tệp DJVU thành chuyển đổi TXT trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
...
Với C ++ OCR và chỉ một vài dòng mã, bạn có thể tạo ứng dụng đầy đủ tính năng để chuyển đổi hình ảnh DJVU thành tài liệu TXT:
