...
title:  
weight: 3920
url: /vi/cpp/conversion/jpeg2000-to-xls/ 
lang: vi
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Mã mẫu cho chuyển đổi Java từ JPEG2000 sang XLS. Sử dụng mã mẫu API cho hàng loạt tệp JPEG2000 thành chuyển đổi XLS trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính Java nào.
---
...
Với C ++ OCR và chỉ một vài dòng mã, bạn có thể tạo ứng dụng đầy đủ tính năng để chuyển đổi hình ảnh JPEG2000 thành tài liệu XLS:
