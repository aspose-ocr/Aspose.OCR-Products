---
title: Convierta JPEG a TXT a través de Java 
url: /es/java/conversion/jpeg-to-txt/ 
description: Ejemplo de código de conversión de Java para formato JPEG a archivo TXT. Utilice este código de ejemplo para convertir JPEG a TXT dentro de cualquier aplicación basada en Java Web o Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta JPEG a TXT a través de Java" h2="Lea texto de JPEG utilizando el reconocimiento óptico de caracteres." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JPEG a TXT usando Java" %}}

Para convertir JPEG a TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir JPEG a TXT a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de JPEG a TXT Java" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir JPEG a TXT" sectionDescription="" >}}
