...
title:  
weight: 3920
url: /es/java/conversion/wbmp-to-xml/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de Java de WBMP a XML. Utilice el código de ejemplo de la API para la conversión por lotes de archivos WBMP a XML dentro de cualquier aplicación web o de escritorio basada en Java.
---
...
Con Java OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen WBMP en un documento XML:
