...
title:  
weight: 3920
url: /es/java/conversion/png-to-txt/ 
lang: es
langdirlevel: 2
...
Con Java OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen PNG en un documento TXT:
