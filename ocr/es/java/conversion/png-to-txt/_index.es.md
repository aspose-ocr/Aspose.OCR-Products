---
title: Convierta PNG a TXT a través de Java 
url: /es/java/conversion/png-to-txt/ 
description: Ejemplo de código de conversión de Java para formato PNG a archivo TXT. Utilice este código de ejemplo para convertir PNG a TXT dentro de cualquier aplicación basada en Java Web o Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta PNG a TXT a través de Java" h2="Lea texto de PNG utilizando el reconocimiento óptico de caracteres." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a TXT usando Java" %}}

Para convertir PNG a TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir PNG a TXT a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de PNG a TXT Java" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir PNG a TXT" sectionDescription="" >}}
