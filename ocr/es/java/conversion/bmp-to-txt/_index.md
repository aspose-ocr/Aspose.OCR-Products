...
description: Código de muestra para la conversión de Java de BMP a TXT. Utilice el código de ejemplo de la API para la conversión por lotes de archivos BMP a TXT dentro de cualquier aplicación web o de escritorio basada en Java.
---
...
Con Java OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen BMP en un documento TXT:
