...
title:  
weight: 3920
url: /es/cpp/conversion/jpeg-to-xls/ 
lang: es
langdirlevel: 2
...
Con C++ OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen JPEG en un documento XLS:
