...
title:  
weight: 3920
url: /es/cpp/conversion/tiff-to-doc/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de Java de TIFF a DOC. Utilice el código de ejemplo de la API para la conversión por lotes de archivos TIFF a DOC dentro de cualquier aplicación web o de escritorio basada en Java.
---
...
Con C++ OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen TIFF en un documento DOC:
