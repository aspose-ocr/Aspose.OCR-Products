---
title: Convierta PNG a XLS a través de C# 
weight: 3920
url: /es/net/conversion/png-to-xls/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de PNG a XLS. Utilice el código de ejemplo de API para la conversión por lotes de archivos PNG a XLS dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen PNG en un documento XLS:
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de PNG a XLS .NET" offSpacer="true" %}}
