---
title: Convierta BMP a DOCX a través de C# 
weight: 3920
url: /es/net/conversion/bmp-to-docx/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de BMP a DOCX. Utilice el código de ejemplo de API para la conversión por lotes de archivos BMP a DOCX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen BMP en un documento DOCX:
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de BMP a DOCX .NET" offSpacer="true" %}}
