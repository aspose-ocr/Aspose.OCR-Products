---
title: Convierta DJVU a PDF a través de C# 
weight: 3920
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen DJVU en un documento PDF:
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de DJVU a PDF .NET" offSpacer="true" %}}
