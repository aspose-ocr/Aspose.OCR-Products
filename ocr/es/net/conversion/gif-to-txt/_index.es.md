---
title: Convierta GIF a TXTO a través de C# 
url: /es/net/conversion/gif-to-txt/ 
description: Código de muestra para la conversión de GIF a TXTO C#. Utilice el código de ejemplo API para la conversión de archivos GIF por lotes a TXTO dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta GIF a TXTO a través de C#" h2="Convierta GIF a txto en cualquier aplicación basada en .NET mediante el reconocimiento óptico de caracteres." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir GIF a TXTO usando C#" %}}

Para convertir GIF a TXTO, utilizaremos <a href=https://products.aspose.com/ocr/net>Aspose.OCR para .NET</a> API, que es una API rica en funciones, potente y API de manipulación y conversión de documentos fácil de usar para la plataforma C#. Abra el administrador de paquetes <a href=https://www.nuget.org/packages/aspose.ocr>NuGet</a>, busque <b>Aspose.OCR</b> e instálelo. También puede usar el siguiente comando desde la Consola del administrador de paquetes.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GIF a TXTO a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de GIF a TXTO C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir GIF a TXTO" sectionDescription="" >}}
