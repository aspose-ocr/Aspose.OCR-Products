---
title: Convierta TIF a XLSX a través de C# 
weight: 3920
url: /es/net/conversion/tif-to-xlsx/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de TIF a XLSX. Utilice el código de ejemplo de API para la conversión por lotes de archivos TIF a XLSX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen TIF en un documento XLSX:
...
+ AsposeOCR.RecognizeImage devuelve una cadena o archivo de tipo XLSX
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de TIF a XLSX .NET" offSpacer="true" %}}
