---
title: Convierta JPEG a DOCX a través de C# 
weight: 3920
url: /es/net/conversion/jpeg-to-docx/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de JPEG a DOCX. Utilice el código de ejemplo de API para la conversión por lotes de archivos JPEG a DOCX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir JPEG a DOCX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de JPEG a DOCX .NET" offSpacer="true" %}}
