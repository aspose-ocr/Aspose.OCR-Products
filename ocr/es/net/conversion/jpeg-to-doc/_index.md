---
title: Convierta JPEG a DOC a través de C# 
weight: 3920
url: /es/net/conversion/jpeg-to-doc/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de JPEG a DOC. Utilice el código de ejemplo de API para la conversión por lotes de archivos JPEG a DOC dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen JPEG en un documento DOC:
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de JPEG a DOC .NET" offSpacer="true" %}}
