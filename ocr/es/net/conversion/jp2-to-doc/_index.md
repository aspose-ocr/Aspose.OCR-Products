---
title: Convierta JP2 a DOC a través de C# 
weight: 3920
url: /es/net/conversion/jp2-to-doc/ 
lang: es
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Código de muestra para la conversión de C# de JP2 a DOC. Utilice el código de ejemplo de API para la conversión por lotes de archivos JP2 a DOC dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
Con .NET OCR y solo unas pocas líneas de código, puede crear una aplicación con todas las funciones que convierte una imagen JP2 en un documento DOC:
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de JP2 a DOC .NET" offSpacer="true" %}}
