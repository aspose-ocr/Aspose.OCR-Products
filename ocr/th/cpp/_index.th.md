...
{{< blocks/products/pf/upper-banner h1="แปลงรูปภาพและ PDF เป็นข้อความใน C++" h2="เพิ่มการรู้จำอักขระด้วยแสง (OCR) ให้กับแอปพลิเคชัน C++ ของคุณด้วยโค้ดสองสามบรรทัด" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/headers/aspose_ocr-for-cpp.svg" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="https://downloads.aspose.com/ocr/cpp" >}}
...
{{< blocks/products/pf/slr-element name="บันทึกประจำรุ่น" href="https://docs.aspose.com/ocr/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
