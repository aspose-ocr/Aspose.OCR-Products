...
title:  
weight: 3920
url: /id/java/conversion/wbmp-to-txt/ 
lang: id
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Contoh kode untuk WBMP ke TXT konversi Java. Gunakan kode contoh API untuk file batch WBMP ke konversi TXT dalam aplikasi berbasis Java Web atau Desktop.
---
...
Dengan Java OCR dan hanya beberapa baris kode, Anda dapat membuat aplikasi berfitur lengkap yang mengubah gambar WBMP menjadi dokumen TXT:
