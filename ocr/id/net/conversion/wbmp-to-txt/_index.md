---
title: Konversi WBMP ke TXT melalui C# 
weight: 3920
url: /id/net/conversion/wbmp-to-txt/ 
lang: id
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Contoh kode untuk WBMP ke TXT C# konversi. Gunakan kode contoh API untuk file batch WBMP ke konversi TXT dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi WBMP ke TXT di C#" h2="Lakukan pengenalan karakter optik pada dokumen WBMP dan simpan teks sebagai dokumen WBMP menggunakan Aspose.OCR dari pustaka .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara mengonversi WBMP ke TXT menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi WBMP ke TXT" %}}

{{% blocks/products/pf/agp/text %}}

Dengan .NET OCR dan hanya beberapa baris kode, Anda dapat membuat aplikasi berfitur lengkap yang mengubah gambar WBMP menjadi dokumen TXT:
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan Konversi WBMP ke TXT .NET" offSpacer="true" %}}
