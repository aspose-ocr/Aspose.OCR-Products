...
description: Exemple de code pour la conversion Java JPG vers PDF. Utilisez un exemple de code d'API pour la conversion par lots de fichiers JPG en PDF dans n'importe quelle application Java Web ou de bureau.
---
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JPG en document PDF :
