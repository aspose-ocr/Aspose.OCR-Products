...
title:  
weight: 3920
url: /fr/cpp/conversion/jp2-to-text/ 
lang: fr
langdirlevel: 2
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JP2 en document Text :
...
+ AsposeOCR.asposeocr_page renvoie une chaîne ou un fichier de type Text
