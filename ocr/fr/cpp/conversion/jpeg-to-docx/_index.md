...
title:  
weight: 3920
url: /fr/cpp/conversion/jpeg-to-docx/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion Java JPEG vers DOCX. Utilisez un exemple de code d'API pour la conversion par lots de fichiers JPEG en DOCX dans n'importe quelle application Java Web ou de bureau.
---
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JPEG en document DOCX :
