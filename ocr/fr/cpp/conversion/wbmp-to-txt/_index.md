...
title:  
weight: 3920
url: /fr/cpp/conversion/wbmp-to-txt/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion Java WBMP vers TXT. Utilisez un exemple de code d'API pour la conversion par lots de fichiers WBMP en TXT dans n'importe quelle application Java Web ou de bureau.
---
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image WBMP en document TXT :
