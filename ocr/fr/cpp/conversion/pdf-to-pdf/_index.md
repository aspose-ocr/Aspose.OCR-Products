...
title:  
weight: 3920
url: /fr/cpp/conversion/pdf-to-pdf/ 
lang: fr
langdirlevel: 2
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image PDF en document PDF :
