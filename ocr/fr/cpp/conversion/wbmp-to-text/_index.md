...
title:  
weight: 3920
url: /fr/cpp/conversion/wbmp-to-text/ 
lang: fr
langdirlevel: 2
...
Avec C++ OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image WBMP en document Text :
