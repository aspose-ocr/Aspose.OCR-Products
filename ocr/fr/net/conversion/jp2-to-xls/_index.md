---
title: Convertir JP2 en XLS via C# 
weight: 3920
url: /fr/net/conversion/jp2-to-xls/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion JP2 vers XLS C#. Utilisez le code d'exemple d'API pour les fichiers batch JP2 vers la conversion XLS dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JP2 en XLS en C#" h2="Effectuez la reconnaissance optique des caractères sur le document JP2 et enregistrez le texte en tant que document JP2 à l'aide d'Aspose.OCR de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.OCR" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JP2 en XLS" %}}

{{% blocks/products/pf/agp/text %}}

Avec .NET OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JP2 en document XLS :
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion JP2 à XLS .NET" offSpacer="true" %}}
