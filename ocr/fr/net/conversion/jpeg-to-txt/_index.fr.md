...
description: Exemple de code pour la conversion JPEG en TXT C#. Utilisez le code d'exemple d'API pour les fichiers JPEG par lots en conversion TXT dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JPEG en TXT via C#" h2="Convertissez JPEG en txte dans n'importe quelle application basée sur .NET à l'aide de la reconnaissance optique de caractères." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JPEG en TXT via C#" %}}
...
1. Passez le chemin du fichier JPEG en paramètre
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion JPEG en TXT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir JPEG en TXT" sectionDescription="" >}}
