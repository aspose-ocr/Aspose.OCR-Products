---
title: Convertir JPEG2000 en DOC via C# 
weight: 3920
url: /fr/net/conversion/jpeg2000-to-doc/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion JPEG2000 vers DOC C#. Utilisez le code d'exemple d'API pour les fichiers batch JPEG2000 vers la conversion DOC dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir JPEG2000 en DOC en C#" h2="Effectuez la reconnaissance optique des caractères sur le document JPEG2000 et enregistrez le texte en tant que document JPEG2000 à l'aide d'Aspose.OCR de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.OCR" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JPEG2000 en DOC" %}}

{{% blocks/products/pf/agp/text %}}

Avec .NET OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JPEG2000 en document DOC :
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion JPEG2000 à DOC .NET" offSpacer="true" %}}
