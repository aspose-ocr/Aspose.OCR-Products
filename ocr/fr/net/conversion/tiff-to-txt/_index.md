...
description: Exemple de code pour la conversion TIFF vers TXT C#. Utilisez le code d'exemple d'API pour les fichiers batch TIFF vers la conversion TXT dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir TIFF en TXT en C#" h2="Effectuez la reconnaissance optique des caractères sur le document TIFF et enregistrez le texte en tant que document TIFF à l'aide d'Aspose.OCR de la bibliothèque .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TIFF en TXT" %}}

{{% blocks/products/pf/agp/text %}}

Avec .NET OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image TIFF en document TXT :
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion TIFF à TXT .NET" offSpacer="true" %}}
