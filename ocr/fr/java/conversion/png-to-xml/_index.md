...
title:  
weight: 3920
url: /fr/java/conversion/png-to-xml/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion Java PNG vers XML. Utilisez un exemple de code d'API pour la conversion par lots de fichiers PNG en XML dans n'importe quelle application Java Web ou de bureau.
---
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image PNG en document XML :
