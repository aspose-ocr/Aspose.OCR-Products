---
title: Convertir JPEG en TXT via Java 
url: /fr/java/conversion/jpeg-to-txt/ 
description: Exemple de code de conversion Java pour le format JPEG en fichier TXT. Utilisez cet exemple de code pour convertir JPEG en TXT dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JPEG en TXT via Java" h2="Lire du texte à partir de JPEG à l'aide de la reconnaissance optique de caractères." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir JPEG en TXT en utilisant Java" %}}

Afin de rendre JPEG en TXT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JPEG en TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java JPEG en TXT" offSpacer="" %}}
```cs
