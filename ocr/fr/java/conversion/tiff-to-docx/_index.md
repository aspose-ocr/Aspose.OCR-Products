...
title:  
weight: 3920
url: /fr/java/conversion/tiff-to-docx/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion Java TIFF vers DOCX. Utilisez un exemple de code d'API pour la conversion par lots de fichiers TIFF en DOCX dans n'importe quelle application Java Web ou de bureau.
---
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image TIFF en document DOCX :
