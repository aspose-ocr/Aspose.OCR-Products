...
description: Exemple de code pour la conversion Java GIF vers XLS. Utilisez un exemple de code d'API pour la conversion par lots de fichiers GIF en XLS dans n'importe quelle application Java Web ou de bureau.
---
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image GIF en document XLS :
