...
description: Exemple de code pour la conversion Java TIFF vers TXT. Utilisez un exemple de code d'API pour la conversion par lots de fichiers TIFF en TXT dans n'importe quelle application Java Web ou de bureau.
---
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image TIFF en document TXT :
