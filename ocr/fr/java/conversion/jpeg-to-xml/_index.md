...
title:  
weight: 3920
url: /fr/java/conversion/jpeg-to-xml/ 
lang: fr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Exemple de code pour la conversion Java JPEG vers XML. Utilisez un exemple de code d'API pour la conversion par lots de fichiers JPEG en XML dans n'importe quelle application Java Web ou de bureau.
---
