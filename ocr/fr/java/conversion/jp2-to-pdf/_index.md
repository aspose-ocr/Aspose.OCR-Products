...
description: Exemple de code pour la conversion Java JP2 vers PDF. Utilisez un exemple de code d'API pour la conversion par lots de fichiers JP2 en PDF dans n'importe quelle application Java Web ou de bureau.
---
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JP2 en document PDF :
