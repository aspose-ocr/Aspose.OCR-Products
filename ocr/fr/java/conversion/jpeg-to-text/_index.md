...
title:  
weight: 3920
url: /fr/java/conversion/jpeg-to-text/ 
lang: fr
langdirlevel: 2
...
Avec Java OCR et seulement quelques lignes de code, vous pouvez créer une application complète qui convertit une image JPEG en document Text :
