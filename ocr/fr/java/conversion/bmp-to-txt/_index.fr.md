---
title: Convertir BMP en TXT via Java 
url: /fr/java/conversion/bmp-to-txt/ 
description: Exemple de code de conversion Java pour le format BMP en fichier TXT. Utilisez cet exemple de code pour convertir BMP en TXT dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir BMP en TXT via Java" h2="Lire du texte à partir de BMP à l'aide de la reconnaissance optique de caractères." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir BMP en TXT en utilisant Java" %}}

Afin de rendre BMP en TXT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir BMP en TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion Java BMP en TXT" offSpacer="" %}}
