---
title: Konwertuj JPG na TEKST za pomocą C# 
url: /pl/net/conversion/jpg-to-text/ 
description: Przykładowy kod konwersji JPG na TEKST C#. Użyj przykładowego kodu API dla wsadowych plików JPG do konwersji TEKSTU w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JPG na TEKST za pomocą C#" h2="Konwertuj JPG na tekst w dowolnej aplikacji opartej na platformie .NET za pomocą optycznego rozpoznawania znaków." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TEXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować JPG na TEKST za pomocą C#" %}}
...
1. Przekaż ścieżkę pliku JPG jako parametr
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję JPG na TEKST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji JPG na TEKST" sectionDescription="" >}}
