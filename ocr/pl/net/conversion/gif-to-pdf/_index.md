...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GIF na PDF" %}}

{{% blocks/products/pf/agp/text %}}

Dzięki .NET OCR i zaledwie kilku linijkom kodu możesz stworzyć w pełni funkcjonalną aplikację, która konwertuje obraz GIF na dokument PDF:
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję GIF na PDF .NET" offSpacer="true" %}}
