...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować TIFF na PDF" %}}

{{% blocks/products/pf/agp/text %}}

Dzięki .NET OCR i zaledwie kilku linijkom kodu możesz stworzyć w pełni funkcjonalną aplikację, która konwertuje obraz TIFF na dokument PDF:
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję TIFF na PDF .NET" offSpacer="true" %}}
