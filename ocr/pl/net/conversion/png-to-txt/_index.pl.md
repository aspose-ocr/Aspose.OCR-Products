---
title: Konwertuj PNG na TEKST za pomocą C# 
url: /pl/net/conversion/png-to-txt/ 
description: Przykładowy kod konwersji PNG na TEKST C#. Użyj przykładowego kodu API dla wsadowych plików PNG do konwersji TEKSTU w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PNG na TEKST za pomocą C#" h2="Konwertuj PNG na tekst w dowolnej aplikacji opartej na platformie .NET za pomocą optycznego rozpoznawania znaków." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PNG na TEKST za pomocą C#" %}}
...
1. Przekaż ścieżkę pliku PNG jako parametr
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję PNG na TEKST C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji PNG na TEKST" sectionDescription="" >}}
