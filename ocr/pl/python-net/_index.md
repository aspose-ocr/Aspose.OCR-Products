---
title: Interfejs API optycznego rozpoznawania znaków dla języka Python
weight: 40
url: /pl/python-net/ 
description: Interfejs API do optycznego rozpoznawania znaków (OCR) dla aplikacji w języku Python. Wyodrębniaj tekst ze skanów i zdjęć, twórz przeszukiwalne pliki PDF, zbiorczo przetwarzaj foldery i archiwa i nie tylko w mniej niż 10 liniach kodu.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Interfejs API optycznego rozpoznawania znaków dla języka Python" h2="Wyodrębniaj tekst z zeskanowanych obrazów, zdjęć i zrzutów ekranu, twórz przeszukiwalne pliki PDF, wyszukuj i porównuj tekst na obrazach i nie tylko z aplikacji Pythona." logoImageSrc="https://releases.aspose.com/images/aspose/header-aspose_ocr-for-python.svg" pfName="Aspose.OCR" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/ocr/python-net" >}}
...
<p><b>Aspose.OCR for Python via .NET</b> to potężny, a jednocześnie łatwy w użyciu mechanizm optycznego rozpoznawania znaków (OCR) dla aplikacji i notatników w języku Python. W mniej niż 10 liniach kodu można rozpoznać tekst w <b>28</b> językach opartych na alfabetach łacińskim, cyrylicy i azjatyckich, zwracając wyniki w najpopularniejszych formatach wymiany dokumentów i danych. Nie ma potrzeby uczenia się skomplikowanych modeli matematycznych, budowania algorytmów uczenia maszynowego i trenowania sieci neuronowych &mdash; nasz prosty i solidny interfejs API zrobi wszystko za Ciebie.</p>
<p>Biblioteka działa równie dobrze ze wszystkimi źródłami, od wysokiej jakości skanu po szybkie zdjęcie na smartfonie. Czy obraz jest obrócony, zniekształcony lub zaszumiony &mdash; automatyczne filtry wstępnego i końcowego przetwarzania zapewniają najwyższą dokładność rozpoznawania w najkrótszym czasie.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="W skrócie" description="Wyodrębnij tekst w głównych językach europejskich i azjatyckich z dowolnego typu obrazu" >}}
...
<li>Zdjęcia</li>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Biblioteka optycznego rozpoznawania znaków" src="https://releases.aspose.com/images/aspose/aspose_ocr-for-python.svg"/>
  <header>
   Aspose.OCR
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Niezależność Platformy" description="Aspose.OCR for Python via .NET działa pod Pythonem w wersji 3.6 lub nowszej" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Obsługiwane formaty plików" description="Konwertuj dowolny obraz ze skanera, aparatu fotograficznego lub Internetu do najpopularniejszych formatów wymiany dokumentów i danych" >}}
...
Wyniki uznania
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API rozpoznawania tekstu" src="https://releases.aspose.com/images/aspose/aspose_ocr-for-python.svg"/>
  <header>
   Aspose.OCR
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">Funkcje i możliwości</h2>
   <p>
   </p>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Wyodrębnij tekst ze skanów, zdjęć i zrzutów ekranu</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text-o ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Konwertuj zeskanowane pliki PDF na pliki PDF z możliwością wyszukiwania i indeksowania</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-globe ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Odczytuj alfabet łaciński, cyrylicę i azjatyckie we wszystkich popularnych krojach pisma</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-language ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Rozpoznaje ponad 6000 chińskich znaków</p>
   </div>   
   <div class="col-lg-4">
    <em class="fa fa-eye ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Pracuj z rozmytymi, zniekształconymi, obróconymi i zaszumionymi obrazami</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-indent ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Zidentyfikuj i zachowaj bloki treści z oryginalnego układu tekstu</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-object-group ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Wykrywaj i czytaj obszary obrazu: akapity, linie i pojedyncze słowa</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-folder-open ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Masowe przetwarzanie wielostronicowych dokumentów, folderów i archiwów</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-link ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Rozpoznawaj obrazy z Internetu bez pobierania</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-check ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Identyfikuj i automatycznie poprawiaj błędnie napisane słowa</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-search ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Znajduj tekst na obrazach i inteligentnie porównuj teksty obrazów</p>
   </div>  
...
<p>Potrzebujesz tylko <b>5</b> linii kodu, aby rozpoznać obraz i wyświetlić wynik. Tak, to naprawdę takie proste!</p>
...
<div class="ocr-lcs">
	...
	<div class="ocr-lcs-controls">
		<div class="ocr-lcs-drop" onclick="OcrLcsUpload(this);" ondragover="event.preventDefault();" ondrop="OcrLcsDropped(event,this);">
			...
			<span class="ocr-lcs-filename">Gotowy do rozpoznania<span></span></span>
			<span class="ocr-lcs-recognizing">Rozpoznawanie <span></span></span>
			<span class="ocr-lcs-hint">Upuść plik tutaj lub kliknij, aby przeglądać *</span>
		</div>
		<div class="ocr-lcs-mods">
			...
			<input type="button" value="Uruchom kod" class="ocr-lcs-recognize ocr-lcs-disabled" onclick="OcrLcsRecognize(this)" />
		</div>
	</div>


	<p class="ocr-lcs-disclaimer">* Przesyłając swoje pliki lub korzystając z usługi, zgadzasz się z naszymi <a href="https://about.aspose.com/legal/terms-of-use" rel="nofollow noreferrer" target="_blank">Warunki użytkowania</a> i <a href="https://about.aspose.com/legal/privacy-policy" rel="nofollow noreferrer" target="_blank">Polityka prywatności</a>.</p>
<div id="code" class="codeblock"><h3>Próbka kodu na żywo - Python 3</h3><pre><code class="cs hljs csharp"><span class="hljs-comment"># Zainicjuj silnik OCR</span>
recognitionEngine = AsposeOcr()
<span class="hljs-comment"># Dodaj obraz do partii</span>
...
<span class="hljs-comment"># Wyodrębnij tekst z obrazu</span>
result = recognitionEngine.recognize(input)
<span class="hljs-comment"># Wyświetl wynik rozpoznawania</span>
...
<div class="col-lg-12">
<h2 class="h2title">28 języków rozpoznawania</h2>
<p><b>Aspose.OCR for Python via .NET</b> rozpoznaje dużą liczbę języków i wszystkie popularne skrypty do pisania, w tym teksty z mieszanymi językami:</p>
<ul>
<li><b>Rozszerzony alfabet łaciński</b>: chorwacki, czeski, duński, holenderski, angielski (w tym pismo odręczne), estoński, fiński, francuski, niemiecki, włoski, łotewski, litewski, norweski, polski, portugalski, rumuński , słowacki, słoweński, hiszpański, szwedzki.</li>
<li><b>Cyrylica</b>: białoruski, bułgarski, kazachski, rosyjski, serbski, ukraiński.</li>
<li><b>Chiński</b>: ponad 6000 znaków.</li>
<li><b>hindi</b></li>
</ul>
<p>Możesz także czytać teksty w innych językach opartych na rozszerzonej łacinie i cyrylicy, nawet jeśli nie są one bezpośrednio obsługiwane przez silnik OCR. Na przykład łacina, wietnamski, gaelicki itd.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Potężne filtry przetwarzania</h2>
<p>Dokładność i niezawodność optycznego rozpoznawania znaków w dużym stopniu zależy od jakości oryginalnego obrazu. <b>Aspose.OCR for Python via .NET</b> oferuje dużą liczbę w pełni zautomatyzowanych i ręcznych filtrów przetwarzania obrazu, które ulepszają obraz przed wysłaniem go do silnika OCR:</p>
<ul>
<li>Automatycznie wyprostuj obrazy wyrównane pod niewielkim kątem do poziomu.</li>
<li>Ręcznie obracaj mocno przekrzywione obrazy.</li>
<li>Automatycznie usuwaj brud, plamy, zadrapania, odblaski, niechciane gradienty i inne szumy.</li>
<li>Automatycznie dostosuj kontrast obrazu.</li>
<li>Automatycznie przeskaluj lub ręcznie zmień rozmiar obrazu.</li>
<li>Konwertuj obrazy na czarno-białe lub w skali szarości.</li>
<li>Odwróć kolory obrazu, aby jasne obszary wyglądały na ciemne, a ciemne na jasne.</li>
<li>Zwiększ grubość znaków na obrazie.</li>
<li>Rozmyj zaszumione obrazy, zachowując krawędzie liter.</li>
<li>Wyprostuj krzywiznę strony i napraw zniekształcenia obiektywu aparatu dla zdjęć stron.</li>
</ul>
<p>Filtry te można łączyć i stosować do całego obrazu lub tylko do wybranych obszarów obrazu, a także w przetwarzaniu wsadowym. Nie tylko możesz precyzyjnie dostroić przetwarzanie wstępne w potoku rozpoznawania, ale także przechowywać przetworzone obrazy do wyświetlania, buforowania i debugowania.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Zoptymalizowany pod kątem określonych typów dokumentów</h2>
<p><b>Aspose.OCR for Python via .NET</b> oferuje specjalnie przeszkolone sieci neuronowe do wydobywania tekstu z niektórych typów obrazów z maksymalną dokładnością:</p>
<ul>
<li>Zskanowane lub sfotografowane dowody osobiste i paszporty.</li>
<li>Tablice rejestracyjne pojazdów.</li>
<li>Faktury.</li>
<li>Rachunki.</li>
</div>

<div class="col-lg-12">
<h2 class="h2title">Wbudowany moduł sprawdzania pisowni</h2>
<p>Chociaż <b>Aspose.OCR dla Pythona za pośrednictwem platformy .NET</b> zapewnia wysoką dokładność rozpoznawania, wady drukowania, zabrudzenia lub niestandardowe czcionki mogą powodować nieprawidłowe rozpoznawanie niektórych znaków lub słów. Aby jeszcze bardziej poprawić wyniki rozpoznawania, możesz włączyć sprawdzanie pisowni, które wyszukuje i automatycznie poprawia błędy pisowni na podstawie wybranego języka rozpoznawania.</p>
<p>Jeśli rozpoznany tekst zawiera specjalistyczną terminologię, skróty i inne słowa, których nie ma w popularnych słownikach ortograficznych, możesz udostępnić własne listy słów.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Tworzenie przeszukiwalnych plików PDF</h2>
<p>Nawet przy najwyższej dokładności rozpoznawania oryginalny obraz może zawierać wiele ważnych informacji nietekstowych lub po prostu mieć dużą wartość historyczną. <b>Aspose.OCR for Python via .NET</b> oferuje proste i eleganckie rozwiązanie łączące najlepsze cechy obu światów. Wyodrębniamy tekst z obrazu, dokumentu PDF lub pakietu plików i umieszczamy go jako niewidoczną warstwę tekstową na oryginalnych obrazach. Wynik jest zapisywany w formacie PDF, który jest branżowym standardem przechowywania i udostępniania dokumentów. Powstałe pliki można przeszukiwać i indeksować, a tekst można zaznaczać i kopiować w taki sam sposób, jak w przypadku wybrania i skopiowania oryginalnych znaków.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Rozpoznawanie zbiorcze</h2>
<p><b>Aspose.OCR for Python via .NET</b> umożliwia rozpoznawanie wielu plików, niezależnie od ich liczby i typu, tak proste, jak odczytanie pojedynczego obrazu. Za pomocą jednego wywołania interfejsu API możesz rozpoznać wiele stron z automatycznego skanera lub wyodrębnić tablice rejestracyjne pojazdów z automatycznych fotoradarów.</p>
<p>Wyniki można zapisać jako przeszukiwalny dokument PDF lub arkusz kalkulacyjny albo zwrócić jako zwykły tekst, JSON lub XML do dalszej analizy.</p>
</div>
...
{{< blocks/products/pf/slr-element name="Dokumentacja" href="https://docs.aspose.com/ocr/python-net/" >}}
{{< blocks/products/pf/slr-element name="Magazyn" href="https://repository.aspose.com/ocr/" >}}
...
{{< blocks/products/pf/slr-element name="Informacje o wydaniu" href="https://releases.aspose.com/ocr/python-net/release-notes/latest/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Dlaczego Aspose.OCR for Python via .NET?" tabId="success-stories" >}}
