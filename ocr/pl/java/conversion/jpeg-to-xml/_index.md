...
title:  
weight: 3920
url: /pl/java/conversion/jpeg-to-xml/ 
lang: pl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Przykładowy kod konwersji JPEG na XML Java. Użyj przykładowego kodu API dla plików wsadowych JPEG do konwersji XML w dowolnej aplikacji internetowej lub opartej na Javie na komputery stacjonarne.
---
...
Dzięki Java OCR i zaledwie kilku linijkom kodu możesz stworzyć w pełni funkcjonalną aplikację, która konwertuje obraz JPEG na dokument XML:
