...
title:  
weight: 3920
url: /pl/java/conversion/bmp-to-json/ 
lang: pl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Przykładowy kod konwersji BMP na JSON Java. Użyj przykładowego kodu API dla plików wsadowych BMP do konwersji JSON w dowolnej aplikacji internetowej lub opartej na Javie na komputery stacjonarne.
---
...
Dzięki Java OCR i zaledwie kilku linijkom kodu możesz stworzyć w pełni funkcjonalną aplikację, która konwertuje obraz BMP na dokument JSON:
