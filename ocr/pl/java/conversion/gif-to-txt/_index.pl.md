---
title: Konwertuj GIF na TXT za pomocą Javy 
url: /pl/java/conversion/gif-to-txt/ 
description: Przykładowy kod konwersji Java dla formatu GIF do pliku TXT. Użyj tego przykładowego kodu, aby przekonwertować GIF na TXT w dowolnej aplikacji internetowej lub aplikacji opartej na języku Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GIF na TXT za pomocą Javy" h2="Czytaj tekst z GIF za pomocą optycznego rozpoznawania znaków." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GIF na TXT za pomocą Javy" %}}

Aby renderować GIF do TXT, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GIF na TXT za pomocą Javy" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji GIF na TXT Java" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji GIF na TXT" sectionDescription="" >}}
