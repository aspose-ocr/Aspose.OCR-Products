...
title:  
weight: 3920
url: /pl/cpp/conversion/djvu-to-txt/ 
lang: pl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Przykładowy kod konwersji DJVU na TXT Java. Użyj przykładowego kodu API dla plików wsadowych DJVU do konwersji TXT w dowolnej aplikacji internetowej lub opartej na Javie na komputery stacjonarne.
---
...
Dzięki C++ OCR i zaledwie kilku linijkom kodu możesz stworzyć w pełni funkcjonalną aplikację, która konwertuje obraz DJVU na dokument TXT:
