...
title:  
weight: 3920
url: /ja/cpp/conversion/jp2-to-docx/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JP2からDOCXへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチJP2ファイルからDOCXへの変換にAPIサンプルコードを使用します。
---
...
C ++ OCRと数行のコードを使用して、JP2画像をDOCXドキュメントに変換するフル機能のアプリケーションを作成できます。
