...
title:  
weight: 3920
url: /ja/cpp/conversion/jp2-to-pdf/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JP2からPDFへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチJP2ファイルからPDFへの変換にAPIサンプルコードを使用します。
---
...
C ++ OCRと数行のコードを使用して、JP2画像をPDFドキュメントに変換するフル機能のアプリケーションを作成できます。
