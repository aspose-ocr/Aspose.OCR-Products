...
title:  
weight: 3920
url: /ja/cpp/conversion/jpg-to-searchable_pdf/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPGからSearchable PDFへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチJPGファイルからSearchable PDFへの変換にAPIサンプルコードを使用します。
---
...
C ++ OCRと数行のコードを使用して、JPG画像をSearchable PDFドキュメントに変換するフル機能のアプリケーションを作成できます。
