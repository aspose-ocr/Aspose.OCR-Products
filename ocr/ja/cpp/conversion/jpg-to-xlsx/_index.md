...
title:  
weight: 3920
url: /ja/cpp/conversion/jpg-to-xlsx/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPGからXLSXへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチJPGファイルからXLSXへの変換にAPIサンプルコードを使用します。
---
...
C ++ OCRと数行のコードを使用して、JPG画像をXLSXドキュメントに変換するフル機能のアプリケーションを作成できます。
