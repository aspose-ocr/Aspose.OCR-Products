...
title:  
weight: 3920
url: /ja/cpp/conversion/tiff-to-xls/ 
lang: ja
langdirlevel: 2
...
C ++ OCRと数行のコードを使用して、TIFF画像をXLSドキュメントに変換するフル機能のアプリケーションを作成できます。
