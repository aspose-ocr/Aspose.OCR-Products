...
title:  
weight: 3920
url: /ja/cpp/conversion/tif-to-searchable_pdf/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIFからSearchable PDFへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチTIFファイルからSearchable PDFへの変換にAPIサンプルコードを使用します。
---
...
C ++ OCRと数行のコードを使用して、TIF画像をSearchable PDFドキュメントに変換するフル機能のアプリケーションを作成できます。
