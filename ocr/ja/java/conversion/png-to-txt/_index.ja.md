...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPNGをTXTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="PNGからTXTへのJava変換ソースコード" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PNGをTXTに変換する無料アプリ" sectionDescription="" >}}
