...
title:  
weight: 3920
url: /ja/java/conversion/jpeg2000-to-xml/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPEG2000からXMLへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチJPEG2000ファイルからXMLへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、JPEG2000画像をXMLドキュメントに変換するフル機能のアプリケーションを作成できます。
