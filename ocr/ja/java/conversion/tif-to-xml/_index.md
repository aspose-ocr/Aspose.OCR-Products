...
title:  
weight: 3920
url: /ja/java/conversion/tif-to-xml/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIFからXMLへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチTIFファイルからXMLへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、TIF画像をXMLドキュメントに変換するフル機能のアプリケーションを作成できます。
