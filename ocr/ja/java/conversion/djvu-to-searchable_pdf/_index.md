...
title:  
weight: 3920
url: /ja/java/conversion/djvu-to-searchable_pdf/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: DJVUからSearchable PDFへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチDJVUファイルからSearchable PDFへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、DJVU画像をSearchable PDFドキュメントに変換するフル機能のアプリケーションを作成できます。
