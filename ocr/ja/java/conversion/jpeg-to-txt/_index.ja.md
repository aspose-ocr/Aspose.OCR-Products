...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してJPEGをTXTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="JPEGからTXTへのJava変換ソースコード" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="JPEGをTXTに変換する無料アプリ" sectionDescription="" >}}
