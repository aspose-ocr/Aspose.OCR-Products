...
title:  
weight: 3920
url: /ja/java/conversion/png-to-xlsx/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: PNGからXLSXへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチPNGファイルからXLSXへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、PNG画像をXLSXドキュメントに変換するフル機能のアプリケーションを作成できます。
