...
title:  
weight: 3920
url: /ja/java/conversion/bmp-to-doc/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: BMPからDOCへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチBMPファイルからDOCへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、BMP画像をDOCドキュメントに変換するフル機能のアプリケーションを作成できます。
