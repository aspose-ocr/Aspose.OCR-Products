---
title: Java経由でGIFをTXTに変換する 
url: /ja/java/conversion/gif-to-txt/ 
description: GIF形式からTXTファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でGIFをTXTに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java経由でGIFをTXTに変換する" h2="光学式文字認識を使用してGIFからテキストを読み取ります。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してGIFをTXTに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してGIFをTXTに変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="GIFからTXTへのJava変換ソースコード" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GIFをTXTに変換する無料アプリ" sectionDescription="" >}}
