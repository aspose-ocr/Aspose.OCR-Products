...
title:  
weight: 3920
url: /ja/java/conversion/pdf-to-docx/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: PDFからDOCXへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチPDFファイルからDOCXへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、PDF画像をDOCXドキュメントに変換するフル機能のアプリケーションを作成できます。
