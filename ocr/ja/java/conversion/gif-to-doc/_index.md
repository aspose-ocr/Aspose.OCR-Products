...
title:  
weight: 3920
url: /ja/java/conversion/gif-to-doc/ 
lang: ja
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: GIFからDOCへのJava変換のサンプルコード。 WebまたはデスクトップJavaベースのアプリケーション内でのバッチGIFファイルからDOCへの変換にAPIサンプルコードを使用します。
---
...
Java OCRと数行のコードを使用して、GIF画像をDOCドキュメントに変換するフル機能のアプリケーションを作成できます。
