...
<p>簡単な<a href="https://docs.aspose.com/ocr/java/installation/">インストール手順</a>に従って、 <a href="https://repository.aspose.com/ocr/">Maven</a>ベースのプロジェクトから直接Aspose.OCRforJavaを使用できます。</p>
