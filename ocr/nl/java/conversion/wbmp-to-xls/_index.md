...
title:  
weight: 3920
url: /nl/java/conversion/wbmp-to-xls/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor WBMP naar XLS Java-conversie. Gebruik API-voorbeeldcode voor batch-WBMP-bestanden naar XLS-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een WBMP-afbeelding converteert naar een XLS-document:
