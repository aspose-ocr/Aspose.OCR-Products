...
title:  
weight: 3920
url: /nl/java/conversion/png-to-doc/ 
lang: nl
langdirlevel: 2
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een PNG-afbeelding converteert naar een DOC-document:
