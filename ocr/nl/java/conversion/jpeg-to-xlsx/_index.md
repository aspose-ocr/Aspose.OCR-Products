...
title:  
weight: 3920
url: /nl/java/conversion/jpeg-to-xlsx/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor JPEG naar XLSX Java-conversie. Gebruik API-voorbeeldcode voor batch-JPEG-bestanden naar XLSX-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een JPEG-afbeelding converteert naar een XLSX-document:
