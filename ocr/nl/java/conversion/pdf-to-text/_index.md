...
title:  
weight: 3920
url: /nl/java/conversion/pdf-to-text/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor PDF naar Text Java-conversie. Gebruik API-voorbeeldcode voor batch-PDF-bestanden naar Text-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een PDF-afbeelding converteert naar een Text-document:
