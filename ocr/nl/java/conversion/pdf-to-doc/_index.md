...
title:  
weight: 3920
url: /nl/java/conversion/pdf-to-doc/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor PDF naar DOC Java-conversie. Gebruik API-voorbeeldcode voor batch-PDF-bestanden naar DOC-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een PDF-afbeelding converteert naar een DOC-document:
