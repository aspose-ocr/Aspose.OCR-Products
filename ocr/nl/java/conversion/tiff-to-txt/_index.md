...
title:  
weight: 3920
url: /nl/java/conversion/tiff-to-txt/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor TIFF naar TXT Java-conversie. Gebruik API-voorbeeldcode voor batch-TIFF-bestanden naar TXT-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een TIFF-afbeelding converteert naar een TXT-document:
