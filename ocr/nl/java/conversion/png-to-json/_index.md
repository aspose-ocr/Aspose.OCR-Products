...
title:  
weight: 3920
url: /nl/java/conversion/png-to-json/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor PNG naar JSON Java-conversie. Gebruik API-voorbeeldcode voor batch-PNG-bestanden naar JSON-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een PNG-afbeelding converteert naar een JSON-document:
