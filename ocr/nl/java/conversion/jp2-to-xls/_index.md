...
title:  
weight: 3920
url: /nl/java/conversion/jp2-to-xls/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor JP2 naar XLS Java-conversie. Gebruik API-voorbeeldcode voor batch-JP2-bestanden naar XLS-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met Java OCR en slechts een paar regels code, kunt u een complete applicatie maken die een JP2-afbeelding converteert naar een XLS-document:
