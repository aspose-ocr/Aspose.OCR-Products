---
title: Converteer GIF naar TXT via Java 
url: /nl/java/conversion/gif-to-txt/ 
description: Voorbeeld Java-conversiecode voor GIF-indeling naar TXT-bestand. Gebruik deze voorbeeldcode om GIF naar TXT te converteren binnen elke web- of desktop-Java-toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer GIF naar TXT via Java" h2="Lees tekst uit GIF met behulp van optische tekenherkenning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe GIF naar TXT te converteren met Java" %}}

Om GIF naar TXT te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om GIF naar TXT te converteren via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF naar TXT Java-conversiebroncode" offSpacer="" %}}
```cs
