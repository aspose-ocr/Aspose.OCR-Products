...
title:  
weight: 3920
url: /nl/cpp/conversion/jp2-to-text/ 
lang: nl
langdirlevel: 2
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een JP2 afbeelding converteert naar een Text document:
...
+ AsposeOCR.asposeocr_page retourneert een String of bestand van het type Text
