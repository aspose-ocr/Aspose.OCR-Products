...
title:  
weight: 3920
url: /nl/cpp/conversion/tiff-to-xlsx/ 
lang: nl
langdirlevel: 2
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een TIFF afbeelding converteert naar een XLSX document:
