...
title:  
weight: 3920
url: /nl/cpp/conversion/gif-to-text/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor GIF naar Text Java-conversie. Gebruik API-voorbeeldcode voor batch-GIF-bestanden naar Text-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een GIF afbeelding converteert naar een Text document:
