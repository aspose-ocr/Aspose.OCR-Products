...
title:  
weight: 3920
url: /nl/cpp/conversion/djvu-to-text/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor DJVU naar Text Java-conversie. Gebruik API-voorbeeldcode voor batch-DJVU-bestanden naar Text-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een DJVU afbeelding converteert naar een Text document:
