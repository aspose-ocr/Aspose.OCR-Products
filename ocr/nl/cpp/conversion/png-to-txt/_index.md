...
title:  
weight: 3920
url: /nl/cpp/conversion/png-to-txt/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor PNG naar TXT Java-conversie. Gebruik API-voorbeeldcode voor batch-PNG-bestanden naar TXT-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een PNG afbeelding converteert naar een TXT document:
