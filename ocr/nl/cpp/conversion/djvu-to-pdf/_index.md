...
title:  
weight: 3920
url: /nl/cpp/conversion/djvu-to-pdf/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor DJVU naar PDF Java-conversie. Gebruik API-voorbeeldcode voor batch-DJVU-bestanden naar PDF-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een DJVU afbeelding converteert naar een PDF document:
