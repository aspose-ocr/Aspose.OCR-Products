...
title:  
weight: 3920
url: /nl/cpp/conversion/pdf-to-text/ 
lang: nl
langdirlevel: 2
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een PDF afbeelding converteert naar een Text document:
