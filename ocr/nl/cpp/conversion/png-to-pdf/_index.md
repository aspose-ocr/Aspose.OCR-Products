...
description: Voorbeeldcode voor PNG naar PDF Java-conversie. Gebruik API-voorbeeldcode voor batch-PNG-bestanden naar PDF-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een PNG afbeelding converteert naar een PDF document:
