...
title:  
weight: 3920
url: /nl/cpp/conversion/wbmp-to-pdf/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor WBMP naar PDF Java-conversie. Gebruik API-voorbeeldcode voor batch-WBMP-bestanden naar PDF-conversie binnen elke web- of desktop-Java-toepassing.
---
...
Met C++ OCR en slechts een paar regels code, kun je een complete applicatie maken die een WBMP afbeelding converteert naar een PDF document:
