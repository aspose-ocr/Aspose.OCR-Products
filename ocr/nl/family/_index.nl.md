---
title: Voeg OCR-mogelijkheden toe aan .NET-, Java- en C++-toepassingen
weight: 10
url: /nl/family
description: Converteer gescande afbeeldingen, schermafbeeldingen, afbeeldingsgebieden en PDF-bestanden naar tekst in .NET-, Java- en C++-toepassingen met behulp van native OCR-API&#39;s.
---
...
NuGet-pakket of zelfstandige bibliotheek die optische tekenherkenning toevoegt aan uw .NET-toepassing.
...
Native API voor desktop- en webapplicaties die kunnen draaien op elk platform dat Java SE of EE ondersteunt.
{{< /blocks/products/pf/product >}}
...
C en C++ OCR API waarmee u afbeeldingen en PDF&#39;s naar tekst kunt converteren op zowel Windows als Linux.
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="Documentatie" href="https://docs.aspose.com/ocr/" >}}
{{< blocks/products/pf/slr-element name="Broncode" href="https://github.com/aspose-ocr?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Waarom Aspose.OCR-productfamilie?" tabId="success-stories" >}}
