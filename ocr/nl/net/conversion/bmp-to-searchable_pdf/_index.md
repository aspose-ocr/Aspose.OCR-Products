---
title: Converteer BMP naar Searchable PDF via C# 
weight: 3920
url: /nl/net/conversion/bmp-to-searchable_pdf/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor BMP naar Searchable PDF C#-conversie. Gebruik API-voorbeeldcode voor batch BMP-bestanden naar Searchable PDF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer BMP naar Searchable PDF in C#" h2="Voer optische tekenherkenning uit op het BMP-document en sla de tekst op als BMP-document met behulp van Aspose.OCR uit de .NET-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Searchable PDF" pfName="Aspose.OCR" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe BMP naar Searchable PDF te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om BMP naar Searchable PDF te converteren" %}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont BMP naar Searchable PDF .NET Conversie" offSpacer="true" %}}
