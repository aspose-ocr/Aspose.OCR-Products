---
title: Converteer JPEG2000 naar DOCX via C# 
weight: 3920
url: /nl/net/conversion/jpeg2000-to-docx/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor JPEG2000 naar DOCX C#-conversie. Gebruik API-voorbeeldcode voor batch JPEG2000-bestanden naar DOCX-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer JPEG2000 naar DOCX in C#" h2="Voer optische tekenherkenning uit op het JPEG2000-document en sla de tekst op als JPEG2000-document met behulp van Aspose.OCR uit de .NET-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="Aspose.OCR" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe JPEG2000 naar DOCX te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om JPEG2000 naar DOCX te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Met .NET OCR en slechts een paar regels code, kunt u een complete toepassing maken die een JPEG2000-afbeelding converteert naar een DOCX-document:
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont JPEG2000 naar DOCX .NET Conversie" offSpacer="true" %}}
