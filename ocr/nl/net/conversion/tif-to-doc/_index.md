---
title: Converteer TIF naar DOC via C# 
weight: 3920
url: /nl/net/conversion/tif-to-doc/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor TIF naar DOC C#-conversie. Gebruik API-voorbeeldcode voor batch TIF-bestanden naar DOC-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer TIF naar DOC in C#" h2="Voer optische tekenherkenning uit op het TIF-document en sla de tekst op als TIF-document met behulp van Aspose.OCR uit de .NET-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.OCR" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe TIF naar DOC te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TIF naar DOC te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Met .NET OCR en slechts een paar regels code, kunt u een complete toepassing maken die een TIF-afbeelding converteert naar een DOC-document:
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont TIF naar DOC .NET Conversie" offSpacer="true" %}}
