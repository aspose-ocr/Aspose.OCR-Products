---
title: Converteer JPG naar JSON via C# 
weight: 3920
url: /nl/net/conversion/jpg-to-json/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor JPG naar JSON C#-conversie. Gebruik API-voorbeeldcode voor batch JPG-bestanden naar JSON-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer JPG naar JSON in C#" h2="Voer optische tekenherkenning uit op het JPG-document en sla de tekst op als JPG-document met behulp van Aspose.OCR uit de .NET-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.OCR" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe JPG naar JSON te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om JPG naar JSON te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Met .NET OCR en slechts een paar regels code, kunt u een complete toepassing maken die een JPG-afbeelding converteert naar een JSON-document:
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont JPG naar JSON .NET Conversie" offSpacer="true" %}}
