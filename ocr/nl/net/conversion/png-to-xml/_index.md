---
title: Converteer PNG naar XML via C# 
weight: 3920
url: /nl/net/conversion/png-to-xml/ 
lang: nl
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Voorbeeldcode voor PNG naar XML C#-conversie. Gebruik API-voorbeeldcode voor batch PNG-bestanden naar XML-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converteer PNG naar XML in C#" h2="Voer optische tekenherkenning uit op het PNG-document en sla de tekst op als PNG-document met behulp van Aspose.OCR uit de .NET-bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="Aspose.OCR" subTitlepfName="voor .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe PNG naar XML te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om PNG naar XML te converteren" %}}
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PNG naar XML .NET Conversie" offSpacer="true" %}}
