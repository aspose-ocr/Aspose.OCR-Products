---
title: Fügen Sie OCR-Funktionen zu .NET-, Java- und C++-Anwendungen hinzu
weight: 10
url: /de/family
description: Konvertieren Sie gescannte Bilder, Screenshots, Bildbereiche und PDF-Dateien in Text in .NET-, Java- und C++-Anwendungen mit nativen OCR-APIs.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie Bilder und PDFs in Text" h2="OCR-Bibliotheken für Desktop- und Webanwendungen, die in C#, Java und C++ geschrieben sind." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr.svg" pfName="Aspose.OCR" downloadUrl="https://releases.aspose.com/ocr" tryOnlineUrl="https://products.aspose.app/ocr/de/scan-image" >}}
...
NuGet-Paket oder eigenständige Bibliothek, die Ihrer .NET-Anwendung optische Zeichenerkennung hinzufügt.
...
Native API für Desktop- und Webanwendungen, die auf jeder Plattform ausgeführt werden können, die Java SE oder EE unterstützt.
{{< /blocks/products/pf/product >}}
...
C- und C++-OCR-API, mit der Sie Bilder und PDFs sowohl unter Windows als auch unter Linux in Text konvertieren können.
{{< /blocks/products/pf/product >}}
