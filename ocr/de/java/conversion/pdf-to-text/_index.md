...
title:  
weight: 3920
url: /de/java/conversion/pdf-to-text/ 
lang: de
langdirlevel: 2
...
Mit Java OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein PDF-Bild in ein Text-Dokument konvertiert:
