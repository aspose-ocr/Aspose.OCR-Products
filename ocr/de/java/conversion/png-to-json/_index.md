...
title:  
weight: 3920
url: /de/java/conversion/png-to-json/ 
lang: de
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Beispielcode für die Java-Konvertierung von PNG in JSON. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von PNG-Dateien in JSON in jeder Web- oder Desktop-Java-basierten Anwendung.
---
...
Mit Java OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein PNG-Bild in ein JSON-Dokument konvertiert:
