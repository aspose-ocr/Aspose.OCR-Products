...
title:  
weight: 3920
url: /de/java/conversion/jpeg-to-json/ 
lang: de
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Beispielcode für die Java-Konvertierung von JPEG in JSON. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von JPEG-Dateien in JSON in jeder Web- oder Desktop-Java-basierten Anwendung.
---
...
Mit Java OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein JPEG-Bild in ein JSON-Dokument konvertiert:
