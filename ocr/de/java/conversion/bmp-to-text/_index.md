...
title:  
weight: 3920
url: /de/java/conversion/bmp-to-text/ 
lang: de
langdirlevel: 2
...
Mit Java OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein BMP-Bild in ein Text-Dokument konvertiert:
...
+ AsposeOCR.RecognizePage gibt einen String oder eine Datei vom Typ Text zurück
