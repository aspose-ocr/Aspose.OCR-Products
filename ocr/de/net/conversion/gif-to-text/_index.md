...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von GIF in Text" %}}

{{% blocks/products/pf/agp/text %}}

Mit .NET OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein GIF-Bild in ein Text-Dokument konvertiert:
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von GIF in Text .NET" offSpacer="true" %}}
