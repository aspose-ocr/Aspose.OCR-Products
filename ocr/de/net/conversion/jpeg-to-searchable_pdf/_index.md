---
title: Konvertieren Sie JPEG in Searchable PDF über C# 
weight: 3920
url: /de/net/conversion/jpeg-to-searchable_pdf/ 
lang: de
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Beispielcode für die C#-Konvertierung von JPEG in Searchable PDF. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von JPEG-Dateien in Searchable PDF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie JPEG in Searchable PDF in C#" h2="Führen Sie eine optische Zeichenerkennung für das JPEG-Dokument durch und speichern Sie Text als JPEG-Dokument mit Aspose.OCR aus der .NET-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Searchable PDF" pfName="Aspose.OCR" subTitlepfName="für .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie JPEG in Searchable PDF mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von JPEG in Searchable PDF" %}}

{{% blocks/products/pf/agp/text %}}

Mit .NET OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein JPEG-Bild in ein Searchable PDF-Dokument konvertiert:
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von JPEG in Searchable PDF .NET" offSpacer="true" %}}
