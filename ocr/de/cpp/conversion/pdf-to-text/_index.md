...
title:  
weight: 3920
url: /de/cpp/conversion/pdf-to-text/ 
lang: de
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Beispielcode für die Java-Konvertierung von PDF in Text. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von PDF-Dateien in Text in jeder Web- oder Desktop-Java-basierten Anwendung.
---
...
Mit C++ OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein PDF-Bild in ein Text-Dokument konvertiert:
