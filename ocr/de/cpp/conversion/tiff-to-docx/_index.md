...
title:  
weight: 3920
url: /de/cpp/conversion/tiff-to-docx/ 
lang: de
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Beispielcode für die Java-Konvertierung von TIFF in DOCX. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von TIFF-Dateien in DOCX in jeder Web- oder Desktop-Java-basierten Anwendung.
---
...
Mit C++ OCR und nur wenigen Codezeilen können Sie eine voll funktionsfähige Anwendung erstellen, die ein TIFF-Bild in ein DOCX-Dokument konvertiert:
