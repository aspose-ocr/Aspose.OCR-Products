...
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie Bilder und PDFs in Text in C++" h2="Fügen Sie Ihren C++-Anwendungen mit wenigen Codezeilen die optische Zeichenerkennung (OCR) hinzu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/headers/aspose_ocr-for-cpp.svg" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="https://releases.aspose.com/ocr/cpp" >}}
