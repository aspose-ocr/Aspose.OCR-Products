---
title: API di riconoscimento ottico dei caratteri per Python
weight: 40
url: /it/python-net/ 
description: Un'API di riconoscimento ottico dei caratteri (OCR) per le tue applicazioni Python. Estrai testo da scansioni e foto, crea PDF ricercabili, elabora cartelle e archivi in ​​blocco e altro ancora in meno di 10 righe di codice.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="API di riconoscimento ottico dei caratteri per Python" h2="Estrai il testo da immagini scansionate, foto e screenshot, crea PDF ricercabili, cerca e confronta il testo nelle immagini e altro dalle applicazioni Python." logoImageSrc="https://releases.aspose.com/images/aspose/header-aspose_ocr-for-python.svg" pfName="Aspose.OCR" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/ocr/python-net" >}}
...
<p><b>Aspose.OCR for Python via .NET</b> è un motore di riconoscimento ottico dei caratteri (OCR) potente e facile da usare per le tue applicazioni e notebook Python. In meno di 10 righe di codice, puoi riconoscere il testo in <b>28</b> lingue basate su caratteri latini, cirillici e asiatici, restituendo risultati nei formati di interscambio di documenti e dati più diffusi. Non è necessario apprendere modelli matematici complessi, creare algoritmi di apprendimento automatico e addestrare reti neurali &mdash; la nostra API semplice e robusta farà tutto per te.</p>
<p>La libreria funziona ugualmente bene con tutte le fonti, da una scansione di alta qualità a una foto veloce su uno smartphone. Se l'immagine è ruotata, distorta o disturbata &mdash; i filtri automatici di pre e post elaborazione forniscono la massima precisione di riconoscimento nel minor tempo possibile.</p>
{{< /blocks/products/pf/tab-content >}}

<!--Diagrams Start-->
{{< blocks/products/pf/carousel >}}

{{< blocks/products/pf/carousel-item h3="A prima vista" description="Estrai il testo nelle principali lingue europee e asiatiche da qualsiasi tipo di immagine" >}}
<div class="diagram1 d1-python">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Libreria di riconoscimento ottico dei caratteri" src="https://releases.aspose.com/images/aspose/aspose_ocr-for-python.svg"/>
  <header>
   Aspose.OCR
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Indipendenza dalla piattaforma" description="Aspose.OCR for Python via .NET funziona con Python versione 3.6 o successiva" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Formati di file supportati" description="Converti qualsiasi immagine da uno scanner, una fotocamera o Internet nei formati di scambio di documenti e dati più diffusi" >}}
...
<div class="d1-col d1-right">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API di riconoscimento del testo" src="https://releases.aspose.com/images/aspose/aspose_ocr-for-python.svg"/>
  <header>
   Aspose.OCR
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">Caratteristiche e capacità</h2>
   <p>
   </p>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Estrai testo da scansioni, foto e screenshot</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-file-text-o ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Converti i PDF scansionati in PDF ricercabili e indicizzabili</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-globe ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Leggi le scritture latine, cirilliche e asiatiche in tutti i caratteri tipografici più diffusi</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-language ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Riconosci più di 6.000 caratteri cinesi</p>
   </div>   
   <div class="col-lg-4">
    <em class="fa fa-eye ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Lavora con immagini sfocate, distorte, ruotate e rumorose</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-indent ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Identifica e preserva i blocchi di contenuto dal layout del testo originale</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-object-group ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Rileva e leggi le aree di un'immagine: paragrafi, righe e singole parole</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-folder-open ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Elabora in blocco documenti, cartelle e archivi multipagina</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-link ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Riconosci le immagini da Internet senza scaricarle</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-check ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Identifica e correggi automaticamente le parole errate</p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-search ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">Trova il testo nelle immagini e confronta in modo intelligente i testi delle immagini</p>
   </div>  
...
<p>Ti servono solo <b>5</b> righe di codice per riconoscere l'immagine e visualizzare il risultato. Si, e davvero cosi semplice!</p>
...
<div class="ocr-lcs">
	...
	<div class="ocr-lcs-controls">
		<div class="ocr-lcs-drop" onclick="OcrLcsUpload(this);" ondragover="event.preventDefault();" ondrop="OcrLcsDropped(event,this);">
			...
			<span class="ocr-lcs-filename">Pronto a riconoscere <span></span></span>
			<span class="ocr-lcs-recognizing">Riconoscendo <span></span></span>
			<span class="ocr-lcs-hint">Trascina un file qui o fai clic per sfogliare *</span>
		</div>
		<div class="ocr-lcs-mods">
			...
			<input type="button" value="Esegui codice" class="ocr-lcs-recognize ocr-lcs-disabled" onclick="OcrLcsRecognize(this)" />
		</div>
	</div>


	<p class="ocr-lcs-disclaimer">* Caricando i tuoi file o utilizzando il servizio accetti i nostri <a href="https://about.aspose.com/legal/terms-of-use" rel="nofollow noreferrer" target="_blank">Termini di utilizzo</a> e <a href="https://about.aspose.com/legal/privacy-policy" rel="nofollow noreferrer" target="_blank">Politica sulla riservatezza</a>.</p>
<div id="code" class="codeblock"><h3>Esempio di codice in tempo reale - Python 3</h3><pre><code class="cs hljs csharp"><span class="hljs-comment"># Inizializza il motore OCR</span>
recognitionEngine = AsposeOcr()
<span class="hljs-comment"># Aggiungi immagine al batch</span>
...
<span class="hljs-comment"># Estrai il testo dall'immagine</span>
result = recognitionEngine.recognize(input)
<span class="hljs-comment"># Visualizza il risultato del riconoscimento</span>
...
<div class="col-lg-12">
<h2 class="h2title">28 lingue di riconoscimento</h2>
<p><b>Aspose.OCR for Python via .NET</b> può riconoscere un gran numero di lingue e tutti gli script di scrittura più diffusi, inclusi testi con lingue miste:</p>
<ul>
<li><b>Alfabeto latino esteso</b>: croato, ceco, danese, olandese, inglese (compresa la scrittura a mano), estone, finlandese, francese, tedesco, italiano, lettone, lituano, norvegese, polacco, portoghese, rumeno , slovacco, sloveno, spagnolo, svedese.</li>
<li><b>Alfabeto cirillico</b>: bielorusso, bulgaro, kazako, russo, serbo, ucraino.</li>
<li><b>Cinese</b>: più di 6.000 caratteri.</li>
<li><b>Hindi</b></li>
</ul>
<p>Puoi anche leggere testi in altre lingue basate sul latino esteso e sul cirillico, anche se non sono direttamente supportati dal motore OCR. Ad esempio, latino, vietnamita, gaelico e così via.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Potenti filtri di elaborazione</h2>
<p>L'accuratezza e l'affidabilità del riconoscimento ottico dei caratteri dipendono fortemente dalla qualità dell'immagine originale. <b>Aspose.OCR for Python via .NET</b> offre un gran numero di filtri di elaborazione delle immagini completamente automatizzati e manuali che migliorano un'immagine prima che venga inviata al motore OCR:</p>
<ul>
<li>Raddrizza automaticamente le immagini allineate con una leggera angolazione rispetto all'orizzontale.</li>
<li>Ruota manualmente le immagini fortemente distorte.</li>
<li>Rimuovi automaticamente sporco, macchie, graffi, bagliori, sfumature indesiderate e altri rumori.</li>
<li>Regola automaticamente il contrasto dell'immagine.</li>
<li>Ingrandisci automaticamente o ridimensiona manualmente l'immagine.</li>
<li>Converti le immagini in bianco e nero o in scala di grigi.</li>
<li>Inverti i colori dell'immagine in modo che le aree chiare appaiano scure e le aree scure appaiano chiare.</li>
<li>Aumenta lo spessore dei caratteri in un'immagine.</li>
<li>Sfoca le immagini rumorose preservando i bordi delle lettere.</li>
<li>Raddrizza la curvatura della pagina e correggi la distorsione dell'obiettivo della fotocamera per le foto della pagina.</li>
</ul>
<p>Questi filtri possono essere combinati e applicati all'intera immagine o solo ad aree selezionate dell'immagine, nonché nell'elaborazione batch. Non solo puoi perfezionare la pre-elaborazione nella pipeline di riconoscimento, ma puoi anche archiviare le immagini elaborate per la visualizzazione, la memorizzazione nella cache e il debug.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Ottimizzato per tipi di documenti specifici</h2>
<p><b>Aspose.OCR for Python via .NET</b> offre reti neurali appositamente addestrate per estrarre il testo da determinati tipi di immagini con la massima precisione:</p>
<ul>
<li>Carte d'identità e passaporti scansionati o fotografati.</li>
<li>Targhe automobilistiche.</li>
<li>Fatture.</li>
<li>Ricevute.</li>
</div>

<div class="col-lg-12">
<h2 class="h2title">Controllo ortografico integrato</h2>
<p>Sebbene <b>Aspose.OCR for Python via .NET</b> fornisca un'elevata precisione di riconoscimento, difetti di stampa, sporco o caratteri non standard possono causare il riconoscimento errato di determinati caratteri o parole. Per migliorare ulteriormente i risultati del riconoscimento, puoi attivare il controllo ortografico, che trova e corregge automaticamente gli errori di ortografia in base alla lingua di riconoscimento selezionata.</p>
<p>Se il testo riconosciuto contiene terminologia specializzata, abbreviazioni e altre parole che non sono presenti nei comuni dizionari ortografici, puoi fornire i tuoi elenchi di parole.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Creazione di PDF ricercabili</h2>
<p>Anche con la massima precisione di riconoscimento, l'immagine originale può contenere molte importanti informazioni non testuali o semplicemente avere un grande valore storico. <b>Aspose.OCR for Python via .NET</b> offre una soluzione semplice ed elegante per combinare il meglio dei due mondi. Estraiamo il testo da un'immagine, un documento PDF o un pacchetto di file e lo posizioniamo come un livello di testo invisibile sopra le immagini originali. Il risultato viene salvato in formato PDF, che è lo standard del settore per l'archiviazione e la condivisione di documenti. I file risultanti possono essere cercati e indicizzati e il testo può essere selezionato e copiato come se avessi selezionato e copiato i caratteri originali.</p>
</div>

<div class="col-lg-12">
<h2 class="h2title">Riconoscimento collettivo</h2>
<p><b>Aspose.OCR for Python via .NET</b> ti consente di riconoscere più file, indipendentemente dal loro numero e tipo, semplicemente leggendo una singola immagine. Con una singola chiamata API, puoi riconoscere più pagine da uno scanner ad alimentazione automatica o estrarre le targhe dei veicoli dalle telecamere del traffico automatiche.</p>
<p>I risultati possono essere salvati come documenti o fogli di lavoro PDF ricercabili oppure restituiti come testo normale, JSON o XML per ulteriori analisi.</p>
</div>
...
{{< blocks/products/pf/slr-element name="Documentazione" href="https://docs.aspose.com/ocr/python-net/" >}}
{{< blocks/products/pf/slr-element name="Deposito" href="https://repository.aspose.com/ocr/" >}}
...
{{< blocks/products/pf/slr-element name="Note di rilascio" href="https://releases.aspose.com/ocr/python-net/release-notes/latest/" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.OCR for Python via .NET?" tabId="success-stories" >}}
