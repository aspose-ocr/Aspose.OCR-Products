---
title: Converti JPEG in TESTO tramite C# 
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti JPEG in TESTO tramite C#" h2="Converti JPEG in testo in qualsiasi applicazione basata su .NET utilizzando il riconoscimento ottico dei caratteri." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire JPEG in TXT tramite C#" %}}
...
1. Passare il percorso del file JPEG come parametro
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da JPEG a TXT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire JPEG in TESTO" sectionDescription="" >}}
