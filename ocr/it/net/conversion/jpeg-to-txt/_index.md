---
title: Converti JPEG in TXT tramite C# 
weight: 3920
url: /it/net/conversion/jpeg-to-txt/ 
lang: it
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Codice di esempio per la conversione da JPEG a TXT C#. Utilizzare il codice di esempio API per la conversione batch di file JPEG in TXT all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti JPEG in TXT in C#" h2="Esegui il riconoscimento ottico dei caratteri sul documento JPEG e salva il testo come documento JPEG utilizzando Aspose.OCR dalla libreria .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire JPEG in TXT" %}}

{{% blocks/products/pf/agp/text %}}

Con .NET OCR e poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JPEG in un documento TXT:
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da JPEG a TXT .NET" offSpacer="true" %}}
