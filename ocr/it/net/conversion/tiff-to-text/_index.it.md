...
url: /it/net/conversion/tiff-to-text/ 
description: Codice di esempio per la conversione da TIFF a TEXT C#. Utilizzare il codice di esempio API per la conversione batch di file TIFF in TEXT all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TIFF in TEXT tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da TIFF a TEXT C#" offSpacer="" %}}
