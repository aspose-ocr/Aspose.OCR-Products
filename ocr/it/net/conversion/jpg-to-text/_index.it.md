---
title: Converti JPG in TESTO tramite C# 
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti JPG in TESTO tramite C#" h2="Converti JPG in testo in qualsiasi applicazione basata su .NET utilizzando il riconoscimento ottico dei caratteri." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TEXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire JPG in TEXT tramite C#" %}}
...
1. Passare il percorso del file JPG come parametro
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da JPG a TEXT C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire JPG in TESTO" sectionDescription="" >}}
