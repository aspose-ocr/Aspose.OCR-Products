...
description: Codice di esempio per la conversione Java da PNG a PDF. Utilizzare il codice di esempio API per la conversione batch di file PNG in PDF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine PNG in un documento PDF:
