...
title:  
weight: 3920
url: /it/java/conversion/jp2-to-xls/ 
lang: it
langdirlevel: 2
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JP2 in un documento XLS:
