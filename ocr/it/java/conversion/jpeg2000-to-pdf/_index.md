...
description: Codice di esempio per la conversione Java da JPEG2000 a PDF. Utilizzare il codice di esempio API per la conversione batch di file JPEG2000 in PDF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JPEG2000 in un documento PDF:
