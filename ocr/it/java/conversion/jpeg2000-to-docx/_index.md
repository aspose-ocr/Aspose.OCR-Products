...
title:  
weight: 3920
url: /it/java/conversion/jpeg2000-to-docx/ 
lang: it
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Codice di esempio per la conversione Java da JPEG2000 a DOCX. Utilizzare il codice di esempio API per la conversione batch di file JPEG2000 in DOCX all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JPEG2000 in un documento DOCX:
