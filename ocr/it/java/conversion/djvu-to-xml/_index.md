...
title:  
weight: 3920
url: /it/java/conversion/djvu-to-xml/ 
lang: it
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Codice di esempio per la conversione Java da DJVU a XML. Utilizzare il codice di esempio API per la conversione batch di file DJVU in XML all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
