---
title: Converti GIF in TXT tramite Java 
url: /it/java/conversion/gif-to-txt/ 
description: Esempio di codice di conversione Java per il formato GIF in file TXT. Utilizzare questo codice di esempio per convertire GIF in TXT all'interno di qualsiasi applicazione basata su Java Web o Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti GIF in TXT tramite Java" h2="Leggi il testo da GIF utilizzando il riconoscimento ottico dei caratteri." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire GIF in TXT usando Java" %}}

Per rendere GIF in TXT, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire GIF in TXT tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da GIF a TXT" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire GIF in TXT" sectionDescription="" >}}
