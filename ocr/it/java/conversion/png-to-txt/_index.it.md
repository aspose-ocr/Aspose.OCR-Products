---
title: Converti PNG in TXT tramite Java 
url: /it/java/conversion/png-to-txt/ 
description: Esempio di codice di conversione Java per il formato PNG in file TXT. Utilizzare questo codice di esempio per convertire PNG in TXT all'interno di qualsiasi applicazione basata su Java Web o Desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti PNG in TXT tramite Java" h2="Leggi il testo da PNG utilizzando il riconoscimento ottico dei caratteri." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire PNG in TXT usando Java" %}}

Per rendere PNG in TXT, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PNG in TXT tramite Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione Java da PNG a TXT" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire PNG in TXT" sectionDescription="" >}}
