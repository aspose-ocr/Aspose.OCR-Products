...
title:  
weight: 3920
url: /it/java/conversion/png-to-json/ 
lang: it
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Codice di esempio per la conversione Java da PNG a JSON. Utilizzare il codice di esempio API per la conversione batch di file PNG in JSON all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine PNG in un documento JSON:
