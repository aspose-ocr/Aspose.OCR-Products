...
description: Codice di esempio per la conversione Java da JPG a PDF. Utilizzare il codice di esempio API per la conversione batch di file JPG in PDF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JPG in un documento PDF:
...
+ AsposeOCR.RecognizePage restituisce una stringa o un file di tipo PDF
