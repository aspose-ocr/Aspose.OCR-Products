...
title:  
weight: 3920
url: /it/java/conversion/wbmp-to-pdf/ 
lang: it
langdirlevel: 2
...
Con Java OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine WBMP in un documento PDF:
