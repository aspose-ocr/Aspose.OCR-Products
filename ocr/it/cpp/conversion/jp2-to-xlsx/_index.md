...
title:  
weight: 3920
url: /it/cpp/conversion/jp2-to-xlsx/ 
lang: it
langdirlevel: 2
...
Con C++ OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine JP2 in un documento XLSX:
