...
title:  
weight: 3920
url: /it/cpp/conversion/bmp-to-text/ 
lang: it
langdirlevel: 2
...
Con C++ OCR e solo poche righe di codice, puoi creare un'applicazione completa che converte un'immagine BMP in un documento Text:
