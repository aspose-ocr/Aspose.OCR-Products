---
title: Aggiungi funzionalità OCR alle applicazioni .NET, Java e C++
weight: 10
url: /it/family
description: Converti immagini scansionate, schermate, aree immagine e file PDF in testo in applicazioni .NET, Java e C++ utilizzando le API OCR native.
---
...
Pacchetto NuGet o libreria autonoma che aggiunge il riconoscimento ottico dei caratteri all&#39;applicazione .NET.
...
API nativa per applicazioni desktop e web che possono essere eseguite su qualsiasi piattaforma che supporti Java SE o EE.
{{< /blocks/products/pf/product >}}
...
API OCR C e C++ che ti consente di convertire immagini e PDF in testo sia su Windows che su Linux.
{{< /blocks/products/pf/product >}}
