...
title:  
weight: 3920
url: /tr/cpp/conversion/png-to-txt/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: PNG - TXT Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu PNG dosyalarını TXT'ye dönüştürmek için API örnek kodunu kullanın.
---
...
C++ OCR ve yalnızca birkaç satır kodla, bir PNG görüntüsünü TXT belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
