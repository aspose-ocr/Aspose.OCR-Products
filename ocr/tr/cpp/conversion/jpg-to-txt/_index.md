...
title:  
weight: 3920
url: /tr/cpp/conversion/jpg-to-txt/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPG - TXT Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu JPG dosyalarını TXT'ye dönüştürmek için API örnek kodunu kullanın.
---
...
C++ OCR ve yalnızca birkaç satır kodla, bir JPG görüntüsünü TXT belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
