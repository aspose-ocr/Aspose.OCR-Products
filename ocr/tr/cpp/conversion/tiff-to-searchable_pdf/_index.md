...
title:  
weight: 3920
url: /tr/cpp/conversion/tiff-to-searchable_pdf/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIFF - Searchable PDF Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu TIFF dosyalarını Searchable PDF'ye dönüştürmek için API örnek kodunu kullanın.
---
...
C++ OCR ve yalnızca birkaç satır kodla, bir TIFF görüntüsünü Searchable PDF belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
