...
{{% blocks/products/pf/agp/feature-section-col title="BMP'i PDF'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

.NET OCR ve yalnızca birkaç satır kod ile, bir BMP görüntüsünü PDF belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, BMP - PDF .NET Dönüşümünü gösterir" offSpacer="true" %}}
