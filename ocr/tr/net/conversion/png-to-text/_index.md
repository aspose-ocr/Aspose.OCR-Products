...
{{% blocks/products/pf/agp/feature-section-col title="PNG'i Text'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

.NET OCR ve yalnızca birkaç satır kod ile, bir PNG görüntüsünü Text belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PNG - Text .NET Dönüşümünü gösterir" offSpacer="true" %}}
