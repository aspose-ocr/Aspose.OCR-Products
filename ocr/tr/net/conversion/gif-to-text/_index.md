...
{{% blocks/products/pf/agp/feature-section-col title="GIF'i Text'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

.NET OCR ve yalnızca birkaç satır kod ile, bir GIF görüntüsünü Text belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, GIF - Text .NET Dönüşümünü gösterir" offSpacer="true" %}}
