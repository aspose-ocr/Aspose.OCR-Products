...
{{% blocks/products/pf/agp/feature-section-col title="JPEG2000'i XML'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

.NET OCR ve yalnızca birkaç satır kod ile, bir JPEG2000 görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, JPEG2000 - XML .NET Dönüşümünü gösterir" offSpacer="true" %}}
