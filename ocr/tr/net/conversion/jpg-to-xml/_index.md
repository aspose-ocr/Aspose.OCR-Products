...
{{% blocks/products/pf/agp/feature-section-col title="JPG'i XML'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

.NET OCR ve yalnızca birkaç satır kod ile, bir JPG görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, JPG - XML .NET Dönüşümünü gösterir" offSpacer="true" %}}
