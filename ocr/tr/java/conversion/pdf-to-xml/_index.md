...
description: PDF - XML Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu PDF dosyalarını XML'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir PDF görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
