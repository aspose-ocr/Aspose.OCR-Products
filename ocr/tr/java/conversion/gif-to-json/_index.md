...
title:  
weight: 3920
url: /tr/java/conversion/gif-to-json/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: GIF - JSON Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu GIF dosyalarını JSON'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir GIF görüntüsünü JSON belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
