...
title:  
weight: 3920
url: /tr/java/conversion/jp2-to-xml/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JP2 - XML Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu JP2 dosyalarını XML'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir JP2 görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
