...
title:  
weight: 3920
url: /tr/java/conversion/jpg-to-xml/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPG - XML Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu JPG dosyalarını XML'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir JPG görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
