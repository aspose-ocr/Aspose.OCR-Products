...
title:  
weight: 3920
url: /tr/java/conversion/jpeg-to-xml/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: JPEG - XML Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu JPEG dosyalarını XML'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir JPEG görüntüsünü XML belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
