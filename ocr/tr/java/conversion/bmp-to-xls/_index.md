...
title:  
weight: 3920
url: /tr/java/conversion/bmp-to-xls/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: BMP - XLS Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu BMP dosyalarını XLS'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir BMP görüntüsünü XLS belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
