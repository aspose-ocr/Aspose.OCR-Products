---
title: Java ile JPEG'yi TXT'ye dönüştürün 
url: /tr/java/conversion/jpeg-to-txt/ 
description: JPEG formatı için TXT dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada JPEG'yi TXT'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Java ile JPEG'yi TXT'ye dönüştürün" h2="Optik Karakter Tanıma'yı kullanarak JPEG'den metin okuyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak JPEG'yi TXT'ye Dönüştürme" %}}

JPEG'yi TXT'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java ile JPEG'yi TXT'ye Dönüştürme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="JPEG'den TXT'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="JPEG'yi TXT'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="" >}}
