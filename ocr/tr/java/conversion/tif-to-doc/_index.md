...
title:  
weight: 3920
url: /tr/java/conversion/tif-to-doc/ 
lang: tr
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: TIF - DOC Java dönüşümü için örnek kod. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada toplu TIF dosyalarını DOC'ye dönüştürmek için API örnek kodunu kullanın.
---
...
Java OCR ve yalnızca birkaç satır kod ile, bir TIF görüntüsünü DOC belgesine dönüştüren tam özellikli bir uygulama oluşturabilirsiniz:
