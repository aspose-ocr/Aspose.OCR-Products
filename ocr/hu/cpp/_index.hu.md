...
{{< blocks/products/pf/upper-banner h1="Konvertálja a képeket és PDF-eket szöveggé C++ nyelven" h2="Adjon hozzá optikai karakterfelismerést (OCR) a C++ alkalmazásaihoz néhány sor kóddal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/headers/aspose_ocr-for-cpp.svg" pfName="Aspose.OCR" subTitlepfName="for C++" downloadUrl="https://releases.aspose.com/ocr/cpp" >}}
...
{{< blocks/products/pf/slr-element name="Kiadási megjegyzések" href="https://releases.aspose.com/ocr/cpp/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
