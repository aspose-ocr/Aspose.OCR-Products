...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a JPG TEXT-re konvertálásához C#-on keresztül" %}}
...
1. Paraméterként adja meg a JPG fájl elérési útját
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a JPG SZÖVEG C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a JPG szöveggé konvertálásához" sectionDescription="" >}}
