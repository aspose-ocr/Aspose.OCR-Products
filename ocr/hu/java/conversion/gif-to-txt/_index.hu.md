---
title: GIF konvertálása TXT-re Java segítségével 
url: /hu/java/conversion/gif-to-txt/ 
description: Java konverziós kód minta GIF formátumhoz TXT fájllá. Ezzel a példakóddal konvertálhatja a GIF-t TXT-vé bármely webes vagy asztali Java alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="GIF konvertálása TXT-re Java segítségével" h2="Olvasson szöveget a GIF-ből az optikai karakterfelismerés segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet GIF-t TXT-re konvertálni Java használatával" %}}

Ahhoz, hogy a GIF-t TXT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a GIF konvertálásához TXT-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF–TXT Java konverziós forráskód" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás GIF-ből TXT-vé konvertálásához" sectionDescription="" >}}
