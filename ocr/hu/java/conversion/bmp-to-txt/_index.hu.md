---
title: BMP konvertálása TXT-re Java segítségével 
url: /hu/java/conversion/bmp-to-txt/ 
description: Java konverziós kód minta BMP formátumhoz TXT fájllá. Ezzel a példakóddal konvertálhatja a BMP-t TXT-vé bármely webes vagy asztali Java alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="BMP konvertálása TXT-re Java segítségével" h2="Olvasson szöveget a BMP-ből az optikai karakterfelismerés segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet BMP-t TXT-re konvertálni Java használatával" %}}

Ahhoz, hogy a BMP-t TXT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a BMP konvertálásához TXT-vé Java segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="BMP–TXT Java konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás BMP-ből TXT-vé konvertálásához" sectionDescription="" >}}
