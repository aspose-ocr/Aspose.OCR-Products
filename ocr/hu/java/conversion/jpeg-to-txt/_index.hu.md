---
title: JPEG konvertálása TXT-re Java segítségével 
url: /hu/java/conversion/jpeg-to-txt/ 
description: Java konverziós kód minta JPEG formátumhoz TXT fájllá. Ezzel a példakóddal konvertálhatja a JPEG-t TXT-vé bármely webes vagy asztali Java alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="JPEG konvertálása TXT-re Java segítségével" h2="Olvasson szöveget a JPEG-ből az optikai karakterfelismerés segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet JPEG-t TXT-re konvertálni Java használatával" %}}

Ahhoz, hogy a JPEG-t TXT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a JPEG konvertálásához TXT-vé Java segítségével" %}}
...
1. Paraméterként adja meg a JPEG fájl elérési útját
...
{{% blocks/products/pf/agp/code-block title="JPEG–TXT Java konverziós forráskód" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás JPEG-ből TXT-vé konvertálásához" sectionDescription="" >}}
