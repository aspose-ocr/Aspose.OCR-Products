---
title: TIFF konvertálása TXT-re Java segítségével 
url: /hu/java/conversion/tiff-to-txt/ 
description: Java konverziós kód minta TIFF formátumhoz TXT fájllá. Ezzel a példakóddal konvertálhatja a TIFF-t TXT-vé bármely webes vagy asztali Java alapú alkalmazáson belül.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="TIFF konvertálása TXT-re Java segítségével" h2="Olvasson szöveget a TIFF-ből az optikai karakterfelismerés segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet TIFF-t TXT-re konvertálni Java használatával" %}}

Ahhoz, hogy a TIFF-t TXT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TIFF konvertálásához TXT-vé Java segítségével" %}}
...
1. Az AsposeOCR.RecognizeLine egy karakterláncot ad vissza felismert szöveggel
1. Szükség esetén alakítsa át a String-et TXT-fájllá
...
- Szerezze be az Aspose.OCR for Java legújabb verzióját közvetlenül a Maventől.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="TIFF–TXT Java konverziós forráskód" offSpacer="" %}}
```cs
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás TIFF-ből TXT-vé konvertálásához" sectionDescription="" >}}
