---
title: Konvertera BMP till TXT via Java 
url: /sv/java/conversion/bmp-to-txt/ 
description: Exempel på Java-konverteringskod för BMP-format till TXT-fil. Använd den här exempelkoden för att konvertera BMP till TXT inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera BMP till TXT via Java" h2="Läs text från BMP med optisk teckenigenkänning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar BMP till TXT med Java" %}}

För att rendera BMP till TXT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera BMP till TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="BMP till TXT Java-konvertering källkod" offSpacer="" %}}
