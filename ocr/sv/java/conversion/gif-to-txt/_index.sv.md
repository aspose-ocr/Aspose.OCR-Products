---
title: Konvertera GIF till TXT via Java 
url: /sv/java/conversion/gif-to-txt/ 
description: Exempel på Java-konverteringskod för GIF-format till TXT-fil. Använd den här exempelkoden för att konvertera GIF till TXT inom alla Java-baserade webb- eller skrivbordsapplikationer.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera GIF till TXT via Java" h2="Läs text från GIF med optisk teckenigenkänning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar GIF till TXT med Java" %}}

För att rendera GIF till TXT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera GIF till TXT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="GIF till TXT Java-konvertering källkod" offSpacer="" %}}
```cs
