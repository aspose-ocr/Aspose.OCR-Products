---
title: Konvertera GIF till TEXT via C# 
url: /sv/net/conversion/gif-to-text/ 
description: Exempelkod för GIF till TEXT C#-konvertering. Använd API-exempelkod för batch-GIF-filer till TEXT-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera GIF till TEXT via C#" h2="Konvertera GIF till text i valfri .NET-baserad applikation med optisk teckenigenkänning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TEXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera GIF till TEXT via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar GIF till TEXT C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera GIF till TEXT" sectionDescription="" >}}
