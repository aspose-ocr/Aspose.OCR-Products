---
title: Konvertera JPEG till TXT via C# 
url: /sv/net/conversion/jpeg-to-txt/ 
description: Exempelkod för JPEG till TXT C#-konvertering. Använd API-exempelkod för batch-JPEG-filer till TXT-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera JPEG till TXT via C#" h2="Konvertera JPEG till txt i valfri .NET-baserad applikation med optisk teckenigenkänning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera JPEG till TXT via C#" %}}
...
1. Skicka in JPEG-filsökvägen som parameter
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar JPEG till TXT C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera JPEG till TXT" sectionDescription="" >}}
