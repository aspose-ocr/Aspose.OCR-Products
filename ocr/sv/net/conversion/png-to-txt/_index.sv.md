---
title: Konvertera PNG till TXT via C# 
url: /sv/net/conversion/png-to-txt/ 
description: Exempelkod för PNG till TXT C#-konvertering. Använd API-exempelkod för batch-PNG-filer till TXT-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PNG till TXT via C#" h2="Konvertera PNG till txt i valfri .NET-baserad applikation med optisk teckenigenkänning." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/ocr/aspose_ocr-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.OCR" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="OCR" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PNG till TXT via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Denna exempelkod visar PNG till TXT C#-konvertering" offSpacer="" %}}
