...
title:  
weight: 3920
url: /lt/java/conversion/pdf-to-docx/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš PDF į DOCX. Naudokite API pavyzdinį kodą paketiniams PDF failams konvertuoti į DOCX bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja PDF vaizdą į DOCX dokumentą:
