...
title:  
weight: 3920
url: /lt/java/conversion/gif-to-json/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš GIF į JSON. Naudokite API pavyzdinį kodą paketiniams GIF failams konvertuoti į JSON bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja GIF vaizdą į JSON dokumentą:
