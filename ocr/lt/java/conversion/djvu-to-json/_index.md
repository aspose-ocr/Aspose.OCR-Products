...
title:  
weight: 3920
url: /lt/java/conversion/djvu-to-json/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš DJVU į JSON. Naudokite API pavyzdinį kodą paketiniams DJVU failams konvertuoti į JSON bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja DJVU vaizdą į JSON dokumentą:
