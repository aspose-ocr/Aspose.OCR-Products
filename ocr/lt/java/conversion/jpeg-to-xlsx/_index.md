...
title:  
weight: 3920
url: /lt/java/conversion/jpeg-to-xlsx/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš JPEG į XLSX. Naudokite API pavyzdinį kodą paketiniams JPEG failams konvertuoti į XLSX bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja JPEG vaizdą į XLSX dokumentą:
