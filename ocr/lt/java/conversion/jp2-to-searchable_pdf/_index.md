...
title:  
weight: 3920
url: /lt/java/conversion/jp2-to-searchable_pdf/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš JP2 į Searchable PDF. Naudokite API pavyzdinį kodą paketiniams JP2 failams konvertuoti į Searchable PDF bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja JP2 vaizdą į Searchable PDF dokumentą:
