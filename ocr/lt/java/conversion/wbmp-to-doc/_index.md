...
title:  
weight: 3920
url: /lt/java/conversion/wbmp-to-doc/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš WBMP į DOC. Naudokite API pavyzdinį kodą paketiniams WBMP failams konvertuoti į DOC bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja WBMP vaizdą į DOC dokumentą:
