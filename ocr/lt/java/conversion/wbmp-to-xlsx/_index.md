...
title:  
weight: 3920
url: /lt/java/conversion/wbmp-to-xlsx/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš WBMP į XLSX. Naudokite API pavyzdinį kodą paketiniams WBMP failams konvertuoti į XLSX bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja WBMP vaizdą į XLSX dokumentą:
