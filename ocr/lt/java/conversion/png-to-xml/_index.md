...
title:  
weight: 3920
url: /lt/java/conversion/png-to-xml/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš PNG į XML. Naudokite API pavyzdinį kodą paketiniams PNG failams konvertuoti į XML bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja PNG vaizdą į XML dokumentą:
