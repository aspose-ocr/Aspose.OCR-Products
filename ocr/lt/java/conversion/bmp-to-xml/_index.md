...
title:  
weight: 3920
url: /lt/java/conversion/bmp-to-xml/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš BMP į XML. Naudokite API pavyzdinį kodą paketiniams BMP failams konvertuoti į XML bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami „Java“ OCR ir vos kelias kodo eilutes galite sukurti visų funkcijų turinčią programą, kuri konvertuoja BMP vaizdą į XML dokumentą:
