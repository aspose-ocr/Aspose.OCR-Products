...
title:  
weight: 3920
url: /lt/cpp/conversion/bmp-to-xlsx/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš BMP į XLSX. Naudokite API pavyzdinį kodą paketiniams BMP failams konvertuoti į XLSX bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami C++ OCR ir vos kelias kodo eilutes, galite sukurti visų funkcijų turinčią programą, kuri konvertuoja BMP vaizdą į XLSX dokumentą:
