...
title:  
weight: 3920
url: /lt/cpp/conversion/djvu-to-pdf/ 
lang: lt
langdirlevel: 2
locales: ja,it,ru,de,es,fr,nl,id,lt,pl,pt,vi,tr,ko
description: Pavyzdinis kodas, skirtas Java konvertavimui iš DJVU į PDF. Naudokite API pavyzdinį kodą paketiniams DJVU failams konvertuoti į PDF bet kurioje žiniatinklio ar darbalaukio Java pagrįstoje programoje.
---
...
Naudodami C++ OCR ir vos kelias kodo eilutes, galite sukurti visų funkcijų turinčią programą, kuri konvertuoja DJVU vaizdą į PDF dokumentą:
